    ...
    Sub LlenarGrid()
        ...
        If mCol IsNot Nothing Then
            For Each mItem In mCol
                ...
                dgvDetalle.Rows(dgvDetalle.Rows.Count - 1).Cells("Elaborado").Value = mItem.Personas.PER_APE_PAT & " " & mItem.Personas.PER_APE_MAT & " " & mItem.Personas.PER_NOMBRES
                dgvDetalle.Rows(dgvDetalle.Rows.Count - 1).Cells("Revisado").Value = mItem.Personas1.PER_APE_PAT & " " & mItem.Personas1.PER_APE_MAT & " " & mItem.Personas1.PER_NOMBRES
                dgvDetalle.Rows(dgvDetalle.Rows.Count - 1).Cells("Aprobado").Value = mItem.Personas2.PER_APE_PAT & " " & mItem.Personas2.PER_APE_MAT & " " & mItem.Personas2.PER_NOMBRES
            Next
        End If
