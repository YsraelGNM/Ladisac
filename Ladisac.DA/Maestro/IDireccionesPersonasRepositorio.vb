...
Namespace Ladisac.DA
    Public Interface IDireccionesPersonasRepositorio
        Function Maintenance(ByVal item As DireccionesPersonas) As Short
        ...
        Function spInsertarRegistro(ByVal cDIR_ID As String, _
                                    ...
                                    ByVal cDIR_FEC_GRAB As DateTime, _
                                    ByVal cDIR_ESTADO As Boolean) As Short
        Function spEliminarRegistro(ByVal cDIR_ID As String, ByVal cPER_ID As String) As Short
        Function spEliminarRegistroNuevo(ByVal cDIR_ID As String, ByVal cPER_ID As String, ByVal cUSU_ID As String) As Short
    End Interface
End Namespace
