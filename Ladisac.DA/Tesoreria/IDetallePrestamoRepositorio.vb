...
Namespace Ladisac.DA
    ...
    Public Interface IDetallePrestamoRepositorio
        Function Maintenance(ByVal item As DetallePrestamo) As Short
        ...
        Function spActualizarRegistro(ByVal cTDO_ID As String,
           ...
           ByVal cDPR_SERIE As String,
           ByVal cDPR_NUMERO As String,
           ByVal cCCT_ID As String,
           ByVal cMON_ID As String,
           ByVal cDPR_ITEM As Int16,
           ByVal cPER_ID_CLI As String,
           ByVal cDPR_FEC_VEN As DateTime,
           ByVal cDPR_CAPITAL As Double,
           ByVal cDPR_INTERES As Double,
           ByVal cDPR_GASTOS As Double,
           ByVal cDPR_IMPORTE As Double,
           ByVal cDPR_CONTRAVALOR As Double,
           ByVal cDPR_OBSERVACIONES As String,
           ByVal cTDO_ID_DOC As String,
           ByVal cDTD_ID_DOC As String,
           ByVal cCCT_ID_DOC As String,
           ByVal cDPR_SERIE_DOC As String,
           ByVal cDPR_NUMERO_DOC As String,
           ByVal cPER_ID_CLI_DOC As String,
           ByVal cUSU_ID As String,
           ByVal cDPR_FEC_GRAB As DateTime,
