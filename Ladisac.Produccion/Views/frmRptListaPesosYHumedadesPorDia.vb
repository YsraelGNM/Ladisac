...
Public Class frmRptListaPesosYHumedadesPorDia
    <Dependency()> _
    Public Property BCProduccion As Ladisac.BL.IBCProduccion

    Private Sub frmRptListaPesosYHumedadesPorDia_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnVisualizar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnVisualizar.Click
        Try
            ...
            Dim query = BCProduccion.ListaPesosYHumedadesPorDia(dtpFecha.Value.Date)
            Dim rea As New StringReader(query)
            ds.ReadXml(rea)

            ReportViewer1.LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("dsListaPesosYHumedadesporDia", ds.Tables(0)))
            ...
            parametro(0) = New Microsoft.Reporting.WinForms.ReportParameter("Fecha", dtpFecha.Value.ToString)
