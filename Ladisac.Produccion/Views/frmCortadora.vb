...
Public Class frmCortadora
    ...
    Protected mCortadora As Cortadora

    'ingreso de codigo
    Private Sub frmCortadora_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LimpiarControles()
    ...
    Sub LlenarControles()
        txtCodigo.Text = mCortadora.COR_ID
        txtDescripcion.Text = mCortadora.COR_DESCRIPCION
    End Sub
    ...
    Sub CargarCortadora(ByVal COR_Id As Integer)
        mCortadora = BCCortadora.CortadoraGetById(COR_Id)
        mCortadora.MarkAsModified()
    End Sub
    ...
    Public Overrides Sub OnManGuardar()
        ...
        If mCortadora IsNot Nothing Then
            mCortadora.COR_DESCRIPCION = txtDescripcion.Text
            mCortadora.COR_ESTADO = True
            mCortadora.COR_FEC_GRAB = Now
            mCortadora.USU_ID = SessionServer.UserId
            BCCortadora.MantenimientoCortadora(mCortadora)
            LimpiarControles()
        End If
    ...
    Public Overrides Sub OnManNuevo()
        LimpiarControles()
        mCortadora = New Cortadora
        mCortadora.MarkAsAdded()
