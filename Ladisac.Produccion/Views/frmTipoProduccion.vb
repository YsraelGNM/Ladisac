...
Public Class frmTipoProduccion
    <Dependency()> _
    ...
    Protected mTipoProduccion As TipoProduccion

    'ingreso de codigo
    Private Sub frmTipoProduccion_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LimpiarControles()
    ...
    Sub LlenarControles()
        txtCodigo.Text = mTipoProduccion.TPR_ID
        txtDescripcion.Text = mTipoProduccion.TPR_DESCRIPCION
    End Sub
    ...
    Sub CargarTipoProduccion(ByVal TPR_Id As Integer)
        mTipoProduccion = BCTipoProduccion.TipoProduccionGetById(TPR_Id)
        mTipoProduccion.MarkAsModified()
    End Sub
    ...
    Public Overrides Sub OnManGuardar()
        ...
        If mTipoProduccion IsNot Nothing Then
            mTipoProduccion.TPR_DESCRIPCION = txtDescripcion.Text
            mTipoProduccion.TPR_ESTADO = True
            mTipoProduccion.TPR_FEC_GRAB = Now
            mTipoProduccion.USU_ID = SessionServer.UserId
            BCTipoProduccion.MantenimientoTipoProduccion(mTipoProduccion)
            LimpiarControles()
        End If
    ...
    Public Overrides Sub OnManNuevo()
        LimpiarControles()
        mTipoProduccion = New TipoProduccion
        mTipoProduccion.MarkAsAdded()
