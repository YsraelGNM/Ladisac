...
Public Class frmExtrusora
    ...
    Protected mExtrusora As Extrusora


    'ingreso de codigo
    Private Sub frmExtrusora_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LimpiarControles()
        '==========================================================================
    ...
    Sub LlenarControles()
        txtCodigo.Text = mExtrusora.EXT_ID
        txtDescripcion.Text = mExtrusora.EXT_DESCRIPCION
    End Sub
    ...
    Sub CargarExtrusora(ByVal EXT_Id As Integer)
        mExtrusora = BCExtrusora.ExtrusoraGetById(EXT_Id)
        mExtrusora.MarkAsModified()
    End Sub
    ...
    Public Overrides Sub OnManGuardar()
        ...
        '---------------------------------------------
        If mExtrusora IsNot Nothing Then
            mExtrusora.EXT_DESCRIPCION = txtDescripcion.Text
            mExtrusora.EXT_ESTADO = True
            mExtrusora.EXT_FEC_GRAB = Now
            mExtrusora.USU_ID = SessionServer.UserId
            BCExtrusora.MantenimientoExtrusora(mExtrusora)
            LimpiarControles()
        End If
        '------------------------------------------
    ...
    Public Overrides Sub OnManNuevo()
        LimpiarControles()
        mExtrusora = New Extrusora
        mExtrusora.MarkAsAdded()
        '---------------------------------------
