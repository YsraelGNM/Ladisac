...
Public Class frmTipoParada
    ...
    Sub LlenarControles()
        txtCodigo.Text = mTipoParada.TPA_ID
    ...
    Sub CargarTipoParada(ByVal TPA_Id As Integer)
        mTipoParada = BCTipoParada.TipoParadaGetById(TPA_Id)
    ...
    Public Overrides Sub OnManGuardar()
        ...
        If mTipoParada IsNot Nothing Then
            ...
            mTipoParada.USU_ID = SessionServer.UserId
            BCTipoParada.MantenimientoTipoParada(mTipoParada)
            LimpiarControles()
        End If
