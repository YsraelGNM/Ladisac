...
Public Class frmPlanta
    ...
    Protected mPlanta As Planta

    'ingreso de codigo
    Private Sub frmPlanta_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LimpiarControles()
    ...
    Sub LlenarControles()
        txtCodigo.Text = mPlanta.PLA_ID
        txtDescripcion.Text = mPlanta.PLA_DESCRIPCION
    End Sub
    ...
    Sub CargarPlanta(ByVal PLA_Id As Integer)
        mPlanta = BCPlanta.PlantaGetById(PLA_Id)
        mPlanta.MarkAsModified()
    End Sub
    ...
    Public Overrides Sub OnManGuardar()
        ...
        If mPlanta IsNot Nothing Then
            mPlanta.PLA_DESCRIPCION = txtDescripcion.Text
            mPlanta.PLA_ESTADO = True
            mPlanta.PLA_FEC_GRAB = Now
            mPlanta.USU_ID = SessionServer.UserId
            BCPlanta.MantenimientoPlanta(mPlanta)
            LimpiarControles()
        End If
