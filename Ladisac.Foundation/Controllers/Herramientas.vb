...
Public Class Herramientas
    ...
    Public Function PermisoEntidadNumero(ByVal ENO_Id As Integer, ByVal Eno_Buscado As Integer) As Integer
        Dim Acceso As Integer = -1
        Dim Item As New Entidad

        Item = BCEntidad.EntidadGetById(ENO_Id)
        Do While Item.ENO_ID <> Eno_Buscado And Item.ENO_ID_PADRE <> -1
            Try
                Item = BCEntidad.EntidadGetById(Item.ENO_ID_PADRE)
                Acceso = Item.ENO_ID
