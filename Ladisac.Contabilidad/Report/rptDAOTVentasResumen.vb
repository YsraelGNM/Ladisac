...
Public Class rptDAOTVentasResumen
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDAOTVentasResumen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDAOTVentasResumen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDAOTVentasResumen = New rptDAOTVentasResumen()
        rpt.Site = Me.Site
        Return rpt
    End Function
