...
Public Class rptLibroInventarioBalance40
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLibroInventarioBalance40.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLibroInventarioBalance40
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLibroInventarioBalance40 = New rptLibroInventarioBalance40()
        rpt.Site = Me.Site
        Return rpt
    End Function
