...
Public Class rptLibroDiarioGeneral
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLibroDiarioGeneral.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_prd_periodo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptLibroDiarioGeneral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLibroDiarioGeneral = New rptLibroDiarioGeneral()
        rpt.Site = Me.Site
        Return rpt
    End Function
