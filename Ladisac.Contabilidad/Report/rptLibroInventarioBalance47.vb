...
Public Class rptLibroInventarioBalance47
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLibroInventarioBalance47.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLibroInventarioBalance47
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLibroInventarioBalance47 = New rptLibroInventarioBalance47()
        rpt.Site = Me.Site
        Return rpt
    End Function
