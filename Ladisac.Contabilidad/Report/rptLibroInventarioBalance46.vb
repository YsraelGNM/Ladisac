...
Public Class rptLibroInventarioBalance46
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLibroInventarioBalance46.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLibroInventarioBalance46
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLibroInventarioBalance46 = New rptLibroInventarioBalance46()
        rpt.Site = Me.Site
        Return rpt
    End Function
