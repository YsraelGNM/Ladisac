...
Public Class rptFormatoInventarioYBalance32
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFormatoInventarioYBalance32.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFormatoInventarioYBalance32
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFormatoInventarioYBalance32 = New rptFormatoInventarioYBalance32()
        rpt.Site = Me.Site
        Return rpt
    End Function
