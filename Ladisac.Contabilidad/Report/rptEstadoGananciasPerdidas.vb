...
Public Class rptEstadoGananciasPerdidas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptEstadoGananciasPerdidas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEstadoGananciasPerdidas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEstadoGananciasPerdidas = New rptEstadoGananciasPerdidas()
        rpt.Site = Me.Site
        Return rpt
    End Function
