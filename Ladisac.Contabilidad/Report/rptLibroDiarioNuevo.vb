...
Public Class rptLibroDiarioNuevo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLibroDiarioNuevo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLibroDiarioNuevo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLibroDiarioNuevo = New rptLibroDiarioNuevo()
        rpt.Site = Me.Site
        Return rpt
    End Function
