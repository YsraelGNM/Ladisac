...
Public Class rptFormatoProveedore42
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFormatoProveedore42.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFormatoProveedore42
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFormatoProveedore42 = New rptFormatoProveedore42()
        rpt.Site = Me.Site
        Return rpt
    End Function
