...
Public Class rptFormatoMayorGeneral61
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptFormatoMayorGeneral61.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_nNivel() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptFormatoMayorGeneral61
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFormatoMayorGeneral61 = New rptFormatoMayorGeneral61()
        rpt.Site = Me.Site
        Return rpt
    End Function
