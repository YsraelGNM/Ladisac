...
Public Class rptLibroInventarioBalance30
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLibroInventarioBalance30.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLibroInventarioBalance30
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLibroInventarioBalance30 = New rptLibroInventarioBalance30()
        rpt.Site = Me.Site
        Return rpt
    End Function
