...
Public Class rptPagosProveedores
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPagosProveedores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPagosProveedores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPagosProveedores = New rptPagosProveedores()
        rpt.Site = Me.Site
        Return rpt
    End Function
