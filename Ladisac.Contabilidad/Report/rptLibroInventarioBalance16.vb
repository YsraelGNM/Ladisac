...
Public Class rptLibroInventarioBalance16
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLibroInventarioBalance16.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLibroInventarioBalance16
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLibroInventarioBalance16 = New rptLibroInventarioBalance16()
        rpt.Site = Me.Site
        Return rpt
    End Function
