...
Public Class rptLibroInventarioBalance10
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLibroInventarioBalance10.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLibroInventarioBalance10
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLibroInventarioBalance10 = New rptLibroInventarioBalance10()
        rpt.Site = Me.Site
        Return rpt
    End Function
