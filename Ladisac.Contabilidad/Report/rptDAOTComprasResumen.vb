...
Public Class rptDAOTComprasResumen
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptDAOTComprasResumen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptDAOTComprasResumen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptDAOTComprasResumen = New rptDAOTComprasResumen()
        rpt.Site = Me.Site
        Return rpt
    End Function
