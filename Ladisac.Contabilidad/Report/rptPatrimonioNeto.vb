...
Public Class rptPatrimonioNeto
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Periodo_id2() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptPatrimonioNeto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPatrimonioNeto = New rptPatrimonioNeto()
        rpt.Site = Me.Site
        Return rpt
    End Function
