...
Public Class rptLibroInventarioBalance42
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLibroInventarioBalance42.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLibroInventarioBalance42
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLibroInventarioBalance42 = New rptLibroInventarioBalance42()
        rpt.Site = Me.Site
        Return rpt
    End Function
