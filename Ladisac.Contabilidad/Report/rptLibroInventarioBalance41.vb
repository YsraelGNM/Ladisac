...
Public Class rptLibroInventarioBalance41
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLibroInventarioBalance41.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLibroInventarioBalance41
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLibroInventarioBalance41 = New rptLibroInventarioBalance41()
        rpt.Site = Me.Site
        Return rpt
    End Function
