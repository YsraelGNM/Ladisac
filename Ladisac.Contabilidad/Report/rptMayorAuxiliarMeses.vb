...
Public Class rptMayorAuxiliarMeses
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptMayorAuxiliarMeses.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMayorAuxiliarMeses
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMayorAuxiliarMeses = New rptMayorAuxiliarMeses()
        rpt.Site = Me.Site
        Return rpt
    End Function
