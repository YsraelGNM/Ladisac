...
Public Class rptLibroInventarioBalance14
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptLibroInventarioBalance14.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLibroInventarioBalance14
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLibroInventarioBalance14 = New rptLibroInventarioBalance14()
        rpt.Site = Me.Site
        Return rpt
    End Function
