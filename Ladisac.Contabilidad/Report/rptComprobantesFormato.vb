...
Public Class rptComprobantesFormato
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptComprobantesFormato.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_per_Id() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptComprobantesFormato
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptComprobantesFormato = New rptComprobantesFormato()
        rpt.Site = Me.Site
        Return rpt
    End Function
