...
#Region "Propiedades primitivas"
	...
	<DataContract()> Partial Public Structure PropertyNames
				...
				public shared MOD_DESCRIPCION As string = "MOD_DESCRIPCION"
				public shared USU_ID As string = "USU_ID"
				public shared MOD_FEC_GRAB As string = "MOD_FEC_GRAB"
				public shared MOD_ESTADO As string = "MOD_ESTADO"
		    End Structure
        ...
        Set(ByVal value As String)
            If Not Equals(_mOD_ID, value) Then
                If ChangeTracker.ChangeTrackingEnabled AndAlso ChangeTracker.State <> ObjectState.Added Then
                    Throw New InvalidOperationException("La propiedad 'MOD_ID' forma parte de la clave del objeto y no se puede modificar. Solo se pueden realizar cambios en las propiedades de clave cuando no se realiza un seguimiento del objeto o su estado es Agregado.")
                End If
                _mOD_ID = value
    ...
    Public Property MOD_DESCRIPCION() As String
        ...
        End Get
        Set(ByVal value As String)
            If Not Equals(_mOD_DESCRIPCION, value) Then
    ...
    Private _mOD_DESCRIPCION As String
    ...
    <DataMember()>
    Public Property MOD_FEC_GRAB() As Date
        Get
            Return _mOD_FEC_GRAB
        End Get
        Set(ByVal value As Date)
            If Not Equals(_mOD_FEC_GRAB, value) Then
                _mOD_FEC_GRAB = value
                OnPropertyChanged("MOD_FEC_GRAB")
            End If
        End Set
    End Property

    Private _mOD_FEC_GRAB As Date
    ...
    Public Property MOD_ESTADO() As Boolean
        ...
        Set(ByVal value As Boolean)
            If Not Equals(_mOD_ESTADO, value) Then
                _mOD_ESTADO = value
    ...
    Private _mOD_ESTADO As Boolean
    ...
    Private Sub FixupActivosFijos(ByVal sender As Object, ByVal e As NotifyCollectionChangedEventArgs)
        ...
        If e.OldItems IsNot Nothing Then
            For Each item As ActivosFijos In e.OldItems
                If ReferenceEquals(item.ModeloArticulos, Me) Then
                    item.ModeloArticulos = Nothing
                End If
                If ChangeTracker.ChangeTrackingEnabled Then
