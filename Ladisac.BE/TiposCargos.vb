...
Partial Public Class TiposCargos
...
#Region "Propiedades primitivas"
	...
	<DataContract()> Partial Public Structure PropertyNames
				...
				public shared tis_Descripcion As string = "tis_Descripcion"
				public shared tis_CodigoSunat As string = "tis_CodigoSunat"
				public shared Usu_Id As string = "Usu_Id"
				public shared tis_FecGrab As string = "tis_FecGrab"
		    End Structure
        ...
        Set(ByVal value As String)
            If Not Equals(_tis_TipCargo_Id, value) Then
                If ChangeTracker.ChangeTrackingEnabled AndAlso ChangeTracker.State <> ObjectState.Added Then
                    Throw New InvalidOperationException("La propiedad 'tis_TipCargo_Id' forma parte de la clave del objeto y no se puede modificar. Solo se pueden realizar cambios en las propiedades de clave cuando no se realiza un seguimiento del objeto o su estado es Agregado.")
                End If
    ...
    Public Property tis_Descripcion() As String
        Get
            Return _tis_Descripcion
        End Get
        Set(ByVal value As String)
            If Not Equals(_tis_Descripcion, value) Then
    ...
    Private _tis_Descripcion As String

    <DataMember()>
    Public Property tis_CodigoSunat() As String
        Get
            Return _tis_CodigoSunat
        End Get
        Set(ByVal value As String)
            If Not Equals(_tis_CodigoSunat, value) Then
                _tis_CodigoSunat = value
                OnPropertyChanged("tis_CodigoSunat")
            End If
        End Set
    End Property

    Private _tis_CodigoSunat As String
    ...
    <DataMember()>
    Public Property tis_FecGrab() As Date
        Get
            Return _tis_FecGrab
        End Get
        Set(ByVal value As Date)
            If Not Equals(_tis_FecGrab, value) Then
                _tis_FecGrab = value
                OnPropertyChanged("tis_FecGrab")
            End If
        End Set
    End Property

    Private _tis_FecGrab As Date
    ...
    Private Sub FixupDatosLaborales(ByVal sender As Object, ByVal e As NotifyCollectionChangedEventArgs)
        ...
        If e.OldItems IsNot Nothing Then
            For Each item As DatosLaborales In e.OldItems
                If ReferenceEquals(item.TiposCargos, Me) Then
                    item.TiposCargos = Nothing
                End If
                If ChangeTracker.ChangeTrackingEnabled Then
