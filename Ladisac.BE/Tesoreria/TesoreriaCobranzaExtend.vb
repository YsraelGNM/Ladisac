...
Public Class TesoreriaCobranza
    ...
    <DataContract()> Partial Public Structure PropertyNames
        ...
        Public Shared TEC_SERIE As String = "TEC_SERIE"
        Public Shared TEC_NUMERO As String = "TEC_NUMERO"
        Public Shared TEC_FECHA_EMI As String = "TEC_FECHA_EMI"
        Public Shared PER_ID_CLI As String = "PER_ID_CLI"
        Public Shared MON_ID As String = "MON_ID"
        Public Shared TEC_MONTO As String = "TEC_MONTO"
        Public Shared USU_ID As String = "USU_ID"
        Public Shared TEC_FEC_GRAB As String = "TEC_FEC_GRAB"
        Public Shared TEC_ESTADO As String = "TEC_ESTADO"
    End Structure

    Public Property TDO_ID As String
    Public Property CCT_ID As String
    Public Property TEC_SERIE As String
    Public Property TEC_NUMERO As String
    Public Property DTD_ID As String
    Public Property TEC_FECHA_EMI As Date
    Public Property PER_ID_CLI As String
    Public Property MON_ID As String
    Public Property TEC_MONTO As Decimal
    Public Property USU_ID As String
    Public Property TEC_FEC_GRAB As Date
    Public Property TEC_ESTADO As Boolean
    ...
    Private Sub ConfigurarDatosCampos()
        ...
        vArrayCamposBusqueda(6) = "TEC_SERIE"
        vArrayCamposBusqueda(7) = "TEC_NUMERO"
        vArrayCamposBusqueda(8) = "TEC_FECHA_EMI"
        ...
        vArrayCamposBusqueda(13) = "TEC_MONTO"
        vArrayCamposBusqueda(14) = "TEC_ESTADO"
        ...
        vArrayDatosComboBox(6).NombreCampo = "TEC_SERIE"
        ...
        vArrayDatosComboBox(7).NombreCampo = "TEC_NUMERO"
        ...
        vArrayDatosComboBox(8).NombreCampo = "TEC_FECHA_EMI"
    ...
    Public Function VerificarDatos(ByVal ParamArray vCampos() As Object) As ErrorData
        ...
        For elemento = 0 To vCampos.Count - 1
            ...
            Select Case vCampos(elemento)
                ...
                Case "TEC_NUMERO"
                    If Len(TEC_NUMERO.Trim) = 10 Then
                    Else
                        VerificarDatos.NumeroError = 0
                ...
                Case "TEC_FECHA_EMI"
                    If TEC_FECHA_EMI.GetType = GetType(Date) Then
                    Else
                        VerificarDatos.NumeroError = 0
                ...
                Case "TEC_MONTO"                    If TEC_MONTO.GetType = GetType(Decimal) Then                    Else                        VerificarDatos.NumeroError = 0                        VerificarDatos.MensajeError = mDato                        VerificarDatos.Objeto = vCampos(elemento)                    End If
                Case "USU_ID"
                ...
                Case "TEC_FEC_GRAB"
                    If TEC_FEC_GRAB.GetType = GetType(DateTime) Then
                    Else
                        VerificarDatos.NumeroError = 0
                        VerificarDatos.MensajeError = mFecha
                        VerificarDatos.Objeto = vCampos(elemento)
                ...
                Case "TEC_ESTADO"
                    If TEC_ESTADO.GetType = GetType(Boolean) Then
                    Else
                        VerificarDatos.NumeroError = 0
    ...
    Public Function SentenciaSqlBusqueda() As String
        ...
        If Vista = "BuscarRegistros" Then
            SentenciaSqlBusqueda = "spVistaTesoreriaCobranzaXML"
        End If
    End Function
    ...
    Public Function ProcesarVerificarDatos(ByVal ParamArray Parametros() As String) As Integer
        Try
            ...
            Else
                oVerificarDatos = VerificarDatos("TDO_ID", "DTD_ID", "CCT_ID", "TEC_SERIE", "TEC_NUMERO", "TEC_FECHA_EMI", "PER_ID_CLI", "MON_ID", "TEC_MONTO", "USU_ID", "TEC_FEC_GRAB", "TEC_ESTADO")
            End If
