...
Partial Public Class SituacionTrabajador
...
#Region "Propiedades primitivas"
	...
	<DataContract()> Partial Public Structure PropertyNames
				...
				public shared sit_Descripcion As string = "sit_Descripcion"
				public shared sit_CodigoSunat As string = "sit_CodigoSunat"
				public shared Usu_Id As string = "Usu_Id"
				public shared sit_FecGrab As string = "sit_FecGrab"
		    End Structure
        ...
        Set(ByVal value As String)
            If Not Equals(_sit_SituaTrab_Id, value) Then
                If ChangeTracker.ChangeTrackingEnabled AndAlso ChangeTracker.State <> ObjectState.Added Then
                    Throw New InvalidOperationException("La propiedad 'sit_SituaTrab_Id' forma parte de la clave del objeto y no se puede modificar. Solo se pueden realizar cambios en las propiedades de clave cuando no se realiza un seguimiento del objeto o su estado es Agregado.")
                End If
    ...
    <DataMember()>
    Public Property sit_Descripcion() As String
        Get
            Return _sit_Descripcion
        End Get
        Set(ByVal value As String)
            If Not Equals(_sit_Descripcion, value) Then
                _sit_Descripcion = value
                OnPropertyChanged("sit_Descripcion")
            End If
        End Set
    End Property

    Private _sit_Descripcion As String

    <DataMember()>
    Public Property sit_CodigoSunat() As String
        Get
            Return _sit_CodigoSunat
        End Get
        Set(ByVal value As String)
            If Not Equals(_sit_CodigoSunat, value) Then
                _sit_CodigoSunat = value
                OnPropertyChanged("sit_CodigoSunat")
            End If
        End Set
    End Property

    Private _sit_CodigoSunat As String
    ...
    <DataMember()>
    Public Property sit_FecGrab() As Date
        Get
            Return _sit_FecGrab
        End Get
        Set(ByVal value As Date)
            If Not Equals(_sit_FecGrab, value) Then
                _sit_FecGrab = value
                OnPropertyChanged("sit_FecGrab")
            End If
        End Set
    End Property

    Private _sit_FecGrab As Date
    ...
    Private Sub FixupDatosLaborales(ByVal sender As Object, ByVal e As NotifyCollectionChangedEventArgs)
        ...
        If e.OldItems IsNot Nothing Then
            For Each item As DatosLaborales In e.OldItems
                If ReferenceEquals(item.SituacionTrabajador, Me) Then
                    item.SituacionTrabajador = Nothing
                End If
                If ChangeTracker.ChangeTrackingEnabled Then
