...
#Region "Propiedades primitivas"
	...
	<DataContract()> Partial Public Structure PropertyNames
				public shared DPA_ID As string = "DPA_ID"
				public shared CPA_ID As string = "CPA_ID"
				public shared ART_ID As string = "ART_ID"
				public shared DPA_CANTIDAD As string = "DPA_CANTIDAD"
		    End Structure
    ...
    <DataMember()>
    Public Property DPA_ID() As Integer
        Get
            Return _dPA_ID
        End Get
        Set(ByVal value As Integer)
            If Not Equals(_dPA_ID, value) Then
                If ChangeTracker.ChangeTrackingEnabled AndAlso ChangeTracker.State <> ObjectState.Added Then
                    Throw New InvalidOperationException("La propiedad 'DPA_ID' forma parte de la clave del objeto y no se puede modificar. Solo se pueden realizar cambios en las propiedades de clave cuando no se realiza un seguimiento del objeto o su estado es Agregado.")
                End If
                _dPA_ID = value
                OnPropertyChanged("DPA_ID")
            End If
        End Set
    End Property

    Private _dPA_ID As Integer
    ...
    <DataMember()>
    Public Property DPA_CANTIDAD() As Nullable(Of Decimal)
        Get
            Return _dPA_CANTIDAD
        End Get
        Set(ByVal value As Nullable(Of Decimal))
            If Not Equals(_dPA_CANTIDAD, value) Then
                _dPA_CANTIDAD = value
                OnPropertyChanged("DPA_CANTIDAD")
            End If
        End Set
    End Property

    Private _dPA_CANTIDAD As Nullable(Of Decimal)
