...
Partial Public Class KardexCtaCteDetracciones
...
#Region "Propiedades primitivas"
	...
	<DataContract()> Partial Public Structure PropertyNames
				...
				public shared montoDetracciones As string = "montoDetracciones"
    ...
    <DataMember()>
    Public Property montoDetracciones() As Nullable(Of Decimal)
        Get
            Return _montoDetracciones
        End Get
        Set(ByVal value As Nullable(Of Decimal))
            If Not Equals(_montoDetracciones, value) Then
                _montoDetracciones = value
                OnPropertyChanged("montoDetracciones")
            End If
        End Set
    End Property

    Private _montoDetracciones As Nullable(Of Decimal)
