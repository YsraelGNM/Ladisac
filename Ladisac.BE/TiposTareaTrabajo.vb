...
Partial Public Class TiposTareaTrabajo
...
#Region "Propiedades primitivas"
	...
	<DataContract()> Partial Public Structure PropertyNames
				...
				public shared tit_TiposTarea As string = "tit_TiposTarea"
    ...
    <DataMember()>
    Public Property tit_TiposTarea() As String
        Get
            Return _tit_TiposTarea
        End Get
        Set(ByVal value As String)
            If Not Equals(_tit_TiposTarea, value) Then
                _tit_TiposTarea = value
                OnPropertyChanged("tit_TiposTarea")
            End If
        End Set
    End Property

    Private _tit_TiposTarea As String
        ...
        Set(ByVal value As TrackableCollection(Of TareaTrabajo))
            If Not Object.ReferenceEquals(_tareaTrabajo, value) Then
                ...
                If _tareaTrabajo IsNot Nothing Then
                    ...
                    For Each item As TareaTrabajo In _tareaTrabajo
    ...
    Private Sub FixupTareaTrabajo(ByVal sender As Object, ByVal e As NotifyCollectionChangedEventArgs)
        ...
        If e.OldItems IsNot Nothing Then
            For Each item As TareaTrabajo In e.OldItems
                If ReferenceEquals(item.TiposTareaTrabajo, Me) Then
