...
Partial Public Class SituacionEspecialTrabajador
...
#Region "Propiedades primitivas"
	...
	<DataContract()> Partial Public Structure PropertyNames
				...
				public shared set_Descripcion As string = "set_Descripcion"
				public shared set_CodigoSunat As string = "set_CodigoSunat"
				public shared Usu_Id As string = "Usu_Id"
				public shared set_FecGrab As string = "set_FecGrab"
		    End Structure
        ...
        Set(ByVal value As String)
            If Not Equals(_set_SituEspe_Id, value) Then
                If ChangeTracker.ChangeTrackingEnabled AndAlso ChangeTracker.State <> ObjectState.Added Then
                    Throw New InvalidOperationException("La propiedad 'set_SituEspe_Id' forma parte de la clave del objeto y no se puede modificar. Solo se pueden realizar cambios en las propiedades de clave cuando no se realiza un seguimiento del objeto o su estado es Agregado.")
                End If
    ...
    <DataMember()>
    Public Property set_Descripcion() As String
        Get
            Return _set_Descripcion
        End Get
        Set(ByVal value As String)
            If Not Equals(_set_Descripcion, value) Then
                _set_Descripcion = value
                OnPropertyChanged("set_Descripcion")
            End If
        End Set
    End Property

    Private _set_Descripcion As String

    <DataMember()>
    Public Property set_CodigoSunat() As String
        Get
            Return _set_CodigoSunat
        End Get
        Set(ByVal value As String)
            If Not Equals(_set_CodigoSunat, value) Then
                _set_CodigoSunat = value
                OnPropertyChanged("set_CodigoSunat")
            End If
        End Set
    End Property

    Private _set_CodigoSunat As String
    ...
    <DataMember()>
    Public Property set_FecGrab() As Date
        Get
            Return _set_FecGrab
        End Get
        Set(ByVal value As Date)
            If Not Equals(_set_FecGrab, value) Then
                _set_FecGrab = value
                OnPropertyChanged("set_FecGrab")
            End If
        End Set
    End Property

    Private _set_FecGrab As Date
    ...
    Private Sub FixupDatosLaborales(ByVal sender As Object, ByVal e As NotifyCollectionChangedEventArgs)
        ...
        If e.NewItems IsNot Nothing Then
            For Each item As DatosLaborales In e.NewItems
                item.SituacionEspecialTrabajador = Me
                If ChangeTracker.ChangeTrackingEnabled Then
        ...
        If e.OldItems IsNot Nothing Then
            For Each item As DatosLaborales In e.OldItems
                If ReferenceEquals(item.SituacionEspecialTrabajador, Me) Then
                    item.SituacionEspecialTrabajador = Nothing
                End If
                If ChangeTracker.ChangeTrackingEnabled Then
