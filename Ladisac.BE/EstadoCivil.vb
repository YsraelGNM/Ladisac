...
#Region "Propiedades primitivas"
	...
	<DataContract()> Partial Public Structure PropertyNames
				public shared ecv_Id As string = "ecv_Id"
				public shared ecv_Descripcion As string = "ecv_Descripcion"
				public shared ecv_CodigoSunat As string = "ecv_CodigoSunat"
		    End Structure
    ...
    <DataMember()>
    Public Property ecv_Id() As String
        Get
            Return _ecv_Id
        End Get
        Set(ByVal value As String)
            If Not Equals(_ecv_Id, value) Then
                If ChangeTracker.ChangeTrackingEnabled AndAlso ChangeTracker.State <> ObjectState.Added Then
                    Throw New InvalidOperationException("La propiedad 'ecv_Id' forma parte de la clave del objeto y no se puede modificar. Solo se pueden realizar cambios en las propiedades de clave cuando no se realiza un seguimiento del objeto o su estado es Agregado.")
                End If
                _ecv_Id = value
                OnPropertyChanged("ecv_Id")
            End If
        End Set
    End Property

    Private _ecv_Id As String

    <DataMember()>
    Public Property ecv_Descripcion() As String
        Get
            Return _ecv_Descripcion
        End Get
        Set(ByVal value As String)
            If Not Equals(_ecv_Descripcion, value) Then
                _ecv_Descripcion = value
                OnPropertyChanged("ecv_Descripcion")
            End If
        End Set
    End Property

    Private _ecv_Descripcion As String

    <DataMember()>
    Public Property ecv_CodigoSunat() As String
        Get
            Return _ecv_CodigoSunat
        End Get
        Set(ByVal value As String)
            If Not Equals(_ecv_CodigoSunat, value) Then
                _ecv_CodigoSunat = value
                OnPropertyChanged("ecv_CodigoSunat")
            End If
        End Set
    End Property

    Private _ecv_CodigoSunat As String
    ...
    Private Sub FixupDatosLaborales(ByVal sender As Object, ByVal e As NotifyCollectionChangedEventArgs)
        ...
        If e.OldItems IsNot Nothing Then
            For Each item As DatosLaborales In e.OldItems
                If ReferenceEquals(item.EstadoCivil, Me) Then
                    item.EstadoCivil = Nothing
                End If
                If ChangeTracker.ChangeTrackingEnabled Then
