...
Partial Public Class NivelEducacion
...
#Region "Propiedades primitivas"
	...
	<DataContract()> Partial Public Structure PropertyNames
				...
				public shared nie_Descipcion As string = "nie_Descipcion"
				public shared nie_CodigoSunat As string = "nie_CodigoSunat"
				public shared Usu_Id As string = "Usu_Id"
				public shared nie_FecGrab As string = "nie_FecGrab"
		    End Structure
        ...
        Set(ByVal value As String)
            If Not Equals(_nie_NiveEduc_Id, value) Then
                If ChangeTracker.ChangeTrackingEnabled AndAlso ChangeTracker.State <> ObjectState.Added Then
                    Throw New InvalidOperationException("La propiedad 'nie_NiveEduc_Id' forma parte de la clave del objeto y no se puede modificar. Solo se pueden realizar cambios en las propiedades de clave cuando no se realiza un seguimiento del objeto o su estado es Agregado.")
                End If
    ...
    <DataMember()>
    Public Property nie_Descipcion() As String
        Get
            Return _nie_Descipcion
        End Get
        Set(ByVal value As String)
            If Not Equals(_nie_Descipcion, value) Then
                _nie_Descipcion = value
                OnPropertyChanged("nie_Descipcion")
            End If
        End Set
    End Property

    Private _nie_Descipcion As String

    <DataMember()>
    Public Property nie_CodigoSunat() As String
        Get
            Return _nie_CodigoSunat
        End Get
        Set(ByVal value As String)
            If Not Equals(_nie_CodigoSunat, value) Then
                _nie_CodigoSunat = value
                OnPropertyChanged("nie_CodigoSunat")
            End If
        End Set
    End Property

    Private _nie_CodigoSunat As String
    ...
    <DataMember()>
    Public Property nie_FecGrab() As Date
        Get
            Return _nie_FecGrab
        End Get
        Set(ByVal value As Date)
            If Not Equals(_nie_FecGrab, value) Then
                _nie_FecGrab = value
                OnPropertyChanged("nie_FecGrab")
            End If
        End Set
    End Property

    Private _nie_FecGrab As Date
    ...
    Private Sub FixupDatosLaborales(ByVal sender As Object, ByVal e As NotifyCollectionChangedEventArgs)
        ...
        If e.OldItems IsNot Nothing Then
            For Each item As DatosLaborales In e.OldItems
                If ReferenceEquals(item.NivelEducacion, Me) Then
                    item.NivelEducacion = Nothing
                End If
                If ChangeTracker.ChangeTrackingEnabled Then
