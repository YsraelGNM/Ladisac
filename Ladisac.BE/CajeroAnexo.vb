...
Partial Public Class CajeroAnexo
...
#Region "Propiedades primitivas"
    ...
    Public Property PER_ID_CAJ() As String
        ...
        Set(ByVal value As String)
            If Not Equals(_pER_ID_CAJ, value) Then
                If ChangeTracker.ChangeTrackingEnabled AndAlso ChangeTracker.State <> ObjectState.Added Then
                    Throw New InvalidOperationException("La propiedad 'PER_ID_CAJ' forma parte de la clave del objeto y no se puede modificar. Solo se pueden realizar cambios en las propiedades de clave cuando no se realiza un seguimiento del objeto o su estado es Agregado.")
                End If
                If Not IsDeserializing Then
    ...
    <DataMember()>
    Public Property CAN_FEC_GRAB() As Date
        Get
    ...
    Private _cAN_FEC_GRAB As Date

    <DataMember()>
    Public Property CAN_ESTADO() As Boolean
        Get
            Return _cAN_ESTADO
        End Get
    ...
    Private _cAN_ESTADO As Boolean
        ...
        Set(ByVal value As Personas)
            If _personas IsNot value Then
                If ChangeTracker.ChangeTrackingEnabled AndAlso ChangeTracker.State <> ObjectState.Added AndAlso value IsNot Nothing Then
                    ...
                    If Not Equals(PER_ID_CAJ, value.PER_ID) Then
...
#Region "Corrección de asociación"
    ...
    Private Sub FixupPersonas(ByVal previousValue As Personas)
        ...
        If previousValue IsNot Nothing AndAlso previousValue.CajeroAnexo.Contains(Me) Then
            previousValue.CajeroAnexo.Remove(Me)
        End If

        If Personas IsNot Nothing Then
            If Not Personas.CajeroAnexo.Contains(Me) Then
                Personas.CajeroAnexo.Add(Me)
            End If
    ...
    Private Sub FixupPuntoVenta(ByVal previousValue As PuntoVenta)
        ...
        If PuntoVenta IsNot Nothing Then
            If Not PuntoVenta.CajeroAnexo.Contains(Me) Then
                PuntoVenta.CajeroAnexo.Add(Me)
            End If
    ...
    Private Sub FixupCajaCtaCte(ByVal previousValue As CajaCtaCte)
        ...
        If CajaCtaCte IsNot Nothing Then
            If Not CajaCtaCte.CajeroAnexo.Contains(Me) Then
                CajaCtaCte.CajeroAnexo.Add(Me)
            End If
    ...
    Private Sub FixupUsuarios(ByVal previousValue As Usuarios)
        ...
        If Usuarios IsNot Nothing Then
            If Not Usuarios.CajeroAnexo.Contains(Me) Then
                Usuarios.CajeroAnexo.Add(Me)
            End If
