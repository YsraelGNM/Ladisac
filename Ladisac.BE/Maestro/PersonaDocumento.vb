Public Class PersonaDocumento
    ...
    Public Shared CODIGO As String = "CODIGO"
    ...
    Private Sub ConfigurarDatosCampos()
        ...
        vArrayCamposBusqueda(72) = "CODIGO"
        vArrayCamposBusqueda(73) = "NOMBRE"
        vArrayCamposBusqueda(74) = "DOCUMENTO"
        vArrayCamposBusqueda(75) = "NUMERO"
        vArrayCamposBusqueda(76) = "ESTADO"
        ...
        vArrayDatosComboBox(72).NombreCampo = "CODIGO"
        vArrayDatosComboBox(72).Longitud = 6
        ...
        vArrayDatosComboBox(72).Ancho = 68
        vArrayDatosComboBox(72).Flag = False

        vArrayDatosComboBox(73).NombreCampo = "NOMBRE"
        vArrayDatosComboBox(73).Longitud = 25
        ...
        vArrayDatosComboBox(73).Ancho = 272
        vArrayDatosComboBox(73).Flag = False

        vArrayDatosComboBox(74).NombreCampo = "DOCUMENTO"
        ...
        vArrayDatosComboBox(75).NombreCampo = "NUMERO"
        vArrayDatosComboBox(75).Longitud = 25
        ...
        vArrayDatosComboBox(75).Ancho = 272
        vArrayDatosComboBox(75).Flag = False

        vArrayDatosComboBox(76).NombreCampo = "ESTADO"
        vArrayDatosComboBox(76).Longitud = 9
        vArrayDatosComboBox(76).Tipo = "varchar"
        vArrayDatosComboBox(76).ParteEntera = 0
        vArrayDatosComboBox(76).ParteDecimal = 0
        ReDim vArrayDatosComboBox(76).Valores(1, 1)
        vArrayDatosComboBox(76).Valores(0, 0) = "NO ACTIVO"
        vArrayDatosComboBox(76).Valores(0, 1) = "0"
        vArrayDatosComboBox(76).Valores(1, 0) = "ACTIVO"
        vArrayDatosComboBox(76).Valores(1, 1) = "1"
        vArrayDatosComboBox(76).Ancho = 85
        vArrayDatosComboBox(76).Flag = True
