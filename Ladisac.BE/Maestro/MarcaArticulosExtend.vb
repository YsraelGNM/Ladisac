...
Partial Public Class MarcaArticulos
    ...
    Public CampoPrincipal = "MAR_ID"
    Public CampoPrincipalValor = MAR_ID
    ...
    Private Sub ConfigurarDatosCampos()
        ...
        vArrayCamposBusqueda(0) = "MAR_ID"
        vArrayCamposBusqueda(1) = "MAR_DESCRIPCION"
        vArrayCamposBusqueda(2) = "MAR_ESTADO"

        vArrayDatosComboBox(0).NombreCampo = "MAR_ID"
        ...
        vArrayDatosComboBox(1).NombreCampo = "MAR_DESCRIPCION"
        ...
        vArrayDatosComboBox(2).NombreCampo = "MAR_ESTADO"
    ...
    Public Function SentenciaSqlBusqueda() As String
        ...
        If Vista = "BuscarRegistros" Then
            SentenciaSqlBusqueda = "spVistaMarcaArticulosXML"
        End If
    End Function
