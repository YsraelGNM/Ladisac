...
Partial Public Class ModeloArticulos
    ...
    Public CampoPrincipal = "MOD_ID"
    Public CampoPrincipalValor = MOD_ID
    ...
    Private Structure sTabla
        ...
        Public ReadOnly Property NombreVista As String
            Get
                Return "vwModeloArticulos"
            End Get
        End Property
        Public ReadOnly Property NombreFuncionVista As String
            Get
                Return "fnVistaModeloArticulos"
            End Get
        End Property
    End Structure
