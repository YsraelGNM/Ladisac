...
Partial Public Class TipoDocPersonas
    ...
    Public CampoPrincipal = "TDP_ID"
    Public CampoPrincipalValor = TDP_ID
    ...
    Private Sub ConfigurarDatosCampos()
        ...
        vArrayCamposBusqueda(0) = "TDP_ID"
        vArrayCamposBusqueda(1) = "TDP_DESCRIPCION"
        vArrayCamposBusqueda(2) = "TDP_LONGITUD"
        vArrayCamposBusqueda(3) = "TDP_COD_SUNAT"
        vArrayCamposBusqueda(4) = "TDP_ESTADO"

        vArrayDatosComboBox(0).NombreCampo = "TDP_ID"
        vArrayDatosComboBox(0).Longitud = 2
        ...
        vArrayDatosComboBox(0).Ancho = 26
        vArrayDatosComboBox(0).Flag = False

        vArrayDatosComboBox(1).NombreCampo = "TDP_DESCRIPCION"
        ...
        vArrayDatosComboBox(2).NombreCampo = "TDP_LONGITUD"
        vArrayDatosComboBox(2).Longitud = 3
        vArrayDatosComboBox(2).Tipo = "numeric"
        vArrayDatosComboBox(2).ParteEntera = 3
        ...
        vArrayDatosComboBox(3).NombreCampo = "TDP_COD_SUNAT"
        ...
        vArrayDatosComboBox(4).NombreCampo = "TDP_ESTADO"
    ...
    Public Function VerificarDatos(ByVal ParamArray vCampos() As String) As ErrorData
        ...
        For elemento = 0 To vCampos.Count - 1
            Select Case vCampos(elemento)
                ...
                Case "TDP_DESCRIPCION"
                    If Len(TDP_DESCRIPCION.Trim) > 0 Then
                    Else
                        VerificarDatos.NumeroError = 0
                ...
                Case "TDP_LONGITUD"
                    If TDP_LONGITUD >= 1 And TDP_LONGITUD <= 999 Then
                    Else
                        VerificarDatos.NumeroError = 0
                ...
                Case "TDP_COD_SUNAT"
                    If Len(TDP_COD_SUNAT.Trim) = 2 Then
                    Else
                        VerificarDatos.NumeroError = 0
                        VerificarDatos.MensajeError = mCodigo2
                        VerificarDatos.Objeto = vCampos(elemento)
                ...
                Case "TDP_FEC_GRAB"
                    If TDP_FEC_GRAB.GetType = GetType(DateTime) Then
                    Else
                        VerificarDatos.NumeroError = 0
                ...
                Case "TDP_ESTADO"
                    If TDP_ESTADO.GetType = GetType(Boolean) Then
                    Else
                        VerificarDatos.NumeroError = 0
    ...
    Public Function SentenciaSqlBusqueda() As String
        ...
        If Vista = "BuscarRegistros" Then
            SentenciaSqlBusqueda = "spVistaTipoDocPersonasXML"
        End If
    End Function
