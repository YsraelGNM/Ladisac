...
Namespace Ladisac.BL
    Public Interface IBCMovimientoCajaBanco
        Function Mantenimiento(ByVal Item As MovimientoCajaBanco) As Short
        ...
        Function ItemMovimientoCajaBanco(ByVal cCcc_Id As String, ByVal cTdo_Id As String, ByVal cDtd_Id As String, ByVal cTes_Serie As String, ByVal cTes_Numero As String) As Integer
        Function ItemMovimientoCajaBancoExtorno(ByVal cCcc_Id As String, ByVal cTdo_Id As String, ByVal cDtd_Id As String, ByVal cTex_Serie As String, ByVal cTex_Numero As String) As Integer
