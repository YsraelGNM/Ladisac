...
Public Class rptPLLXAcumuladosXTrabajador
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPLLXAcumuladosXTrabajador.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPLLXAcumuladosXTrabajador
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPLLXAcumuladosXTrabajador = New rptPLLXAcumuladosXTrabajador()
        rpt.Site = Me.Site
        Return rpt
    End Function
