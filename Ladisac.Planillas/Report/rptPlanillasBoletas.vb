...
Public Class rptPlanillasBoletas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptPlanillasBoletas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPlanillasBoletas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPlanillasBoletas = New rptPlanillasBoletas()
        rpt.Site = Me.Site
        Return rpt
    End Function
