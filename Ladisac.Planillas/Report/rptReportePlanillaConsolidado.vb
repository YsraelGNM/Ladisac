...
Public Class rptReportePlanillaConsolidado
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptReportePlanillaConsolidado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ConceptosXML() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptReportePlanillaConsolidado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReportePlanillaConsolidado = New rptReportePlanillaConsolidado()
        rpt.Site = Me.Site
        Return rpt
    End Function
