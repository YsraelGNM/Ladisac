...
Namespace Ladisac.BL
    Public Class BCDetalleGrupoMantenimiento
        Implements IBCDetalleGrupoMantenimiento
        <Dependency()> _
        Public Property ContainerService As IUnityContainer


        Public Function Maintenance(ByVal item As BE.DetalleGrupoMantenimiento) As Object Implements IBCDetalleGrupoMantenimiento.Maintenance

            Try
                Dim rep = ContainerService.Resolve(Of DA.DetalleGrupoMantenimientoRepositorio)()
