...
Namespace Ladisac.BL
    ...
    Public Class BCConvenioDobleTributacion
        Implements IBCConvenioDobleTributacion

        <Dependency()> _
        Public Property ContainerService As IUnityContainer

        Public Function ConvenioDobleTributacionQuery(ByVal cod_DobleTribu_Id As String, ByVal cod_Descripcion As String) As Object Implements IBCConvenioDobleTributacion.ConvenioDobleTributacionQuery
            Dim result As String = Nothing
            Try
                Dim rep = ContainerService.Resolve(Of DA.IReportesRepositorio)()
                result = rep.EjecutarReporte(DA.SPNames.SPConvenioDobleTributacionSelectXML, cod_DobleTribu_Id, cod_Descripcion)
        ...
        Public Function ConvenioDobleTributacionSeek(ByVal id As String) As BE.ConvenioDobleTributacion Implements IBCConvenioDobleTributacion.ConvenioDobleTributacionSeek
            Dim result As ConvenioDobleTributacion = Nothing
            Try
                Dim rep = ContainerService.Resolve(Of DA.IConvenioDobleTributacionRepositorio)()
        ...
        Public Function MAintenance(ByVal item As BE.ConvenioDobleTributacion) As Object Implements IBCConvenioDobleTributacion.MAintenance
            Try
                Dim rep = ContainerService.Resolve(Of DA.IConvenioDobleTributacionRepositorio)()
