...
Namespace Ladisac.Facturacion.Reportes
    Public Class DocumentosEmitidos3
        ...
        Public Overrides Property ResourceName() As String
            Get
                Return "DocumentosEmitidos3.rpt"
            End Get
    ...
    Public Class CachedDocumentosEmitidos3
        Inherits Component
        ...
        Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
            Dim rpt As DocumentosEmitidos3 = New DocumentosEmitidos3()
            rpt.Site = Me.Site
            Return rpt
        End Function
