...
Public Class ReporteGeneralGeneral1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReporteGeneralGeneral1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteGeneralGeneral1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteGeneralGeneral1 = New ReporteGeneralGeneral1()
        rpt.Site = Me.Site
        Return rpt
    End Function
