...
Namespace Ladisac.Facturacion.Reportes
    Public Class DocumentosEmitidos1
        ...
        Public Overrides Property ResourceName() As String
            Get
                Return "DocumentosEmitidos1.rpt"
            End Get
    ...
    Public Class CachedDocumentosEmitidos1
        Inherits Component
        ...
        Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
            Dim rpt As DocumentosEmitidos1 = New DocumentosEmitidos1()
            rpt.Site = Me.Site
            Return rpt
        End Function
