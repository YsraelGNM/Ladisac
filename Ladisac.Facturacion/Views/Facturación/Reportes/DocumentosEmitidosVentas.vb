...
Public Class DocumentosEmitidosVentas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DocumentosEmitidosVentas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDocumentosEmitidosVentas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DocumentosEmitidosVentas = New DocumentosEmitidosVentas()
        rpt.Site = Me.Site
        Return rpt
    End Function
