...
Public Class ReporteGeneralGeneral2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReporteGeneralGeneral2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteGeneralGeneral2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteGeneralGeneral2 = New ReporteGeneralGeneral2()
        rpt.Site = Me.Site
        Return rpt
    End Function
