...
Namespace Ladisac.Facturacion.Reportes
    Public Class DocumentosEmitidos2
        ...
        Public Overrides Property ResourceName() As String
            Get
                Return "DocumentosEmitidos2.rpt"
            End Get
    ...
    Public Class CachedDocumentosEmitidos2
        Inherits Component
        ...
        Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
            Dim rpt As DocumentosEmitidos2 = New DocumentosEmitidos2()
            rpt.Site = Me.Site
            Return rpt
        End Function
