...
#End Region
        ...
        Private Sub Imprimir()
            ...
            If rbReporteVentasCompartivo.Checked Then
                oReporte = oReporte1
                sr = New StringReader(IBCMaestro.EjecutarVista("fac.spVentasDiamanteComercializadoraPromedioGeneral", dtpFechaInicioAño.Value, dtpFechaFinAño.Value, dtpFechaInicioMes.Value, dtpFechaFinMes.Value, dtpFechaInicioMes1.Value, dtpFechaFinMes1.Value, dtpMesInicio.Value, dtpMesFin.Value, dtpMesInicio1.Value, dtpMesFin1.Value, DBNull.Value, DBNull.Value, DBNull.Value, DBNull.Value))
                sr1 = New StringReader(IBCMaestro.EjecutarVista("fac.spVentasDiamanteComercializadoraPromedioGeneralDetalle", dtpFechaInicioAño.Value, dtpFechaFinAño.Value, dtpFechaInicioMes.Value, dtpFechaFinMes.Value, dtpFechaInicioMes1.Value, dtpFechaFinMes1.Value, dtpMesInicio.Value, dtpMesFin.Value, dtpMesInicio1.Value, dtpMesFin1.Value, DBNull.Value, DBNull.Value, DBNull.Value, DBNull.Value))
                SubTitulo = "Reporte De Ventas Comparativo"
            ElseIf rbReporteAgencia.Checked Then
                oReporte = oReporte2
                sr = New StringReader(IBCMaestro.EjecutarVista("fac.spVentasDiamanteComercializadoraPromedioPuntoVentaGeneral", dtpFechaInicioAño.Value, dtpFechaFinAño.Value, dtpFechaInicioMes.Value, dtpFechaFinMes.Value, dtpFechaInicioMes1.Value, dtpFechaFinMes1.Value, dtpMesInicio.Value, dtpMesFin.Value, dtpMesInicio1.Value, dtpMesFin1.Value,
                                                               "'_01Planta','_02Apacheta','_04McalCastilla','_03ConoNorte','_06Cayma','_05Umacollo','_24CerroColorado'",
                                                               DBNull.Value, DBNull.Value, DBNull.Value, DBNull.Value))
                '' "'AREQUIPA  ADM','AREQUIPA APACHETA','AREQUIPA M-CASTILLA','AREQUIPA- CONO NORTE','AGENCIA CERRO COLORADO','AGENCIA UMACOLLO','AGENCIA CAYMA'",
                ''
                SubTitulo = "Reporte Por Agencia"
            ElseIf rbReporteSucursal.Checked Then
                oReporte = oReporte2
                sr = New StringReader(IBCMaestro.EjecutarVista("fac.spVentasDiamanteComercializadoraPromedioPuntoVentaGeneral", dtpFechaInicioAño.Value, dtpFechaFinAño.Value, dtpFechaInicioMes.Value, dtpFechaFinMes.Value, dtpFechaInicioMes1.Value, dtpFechaFinMes1.Value, dtpMesInicio.Value, dtpMesFin.Value, dtpMesInicio1.Value, dtpMesFin1.Value,
                                                                "'_19Juliaca','_16Camana','_18Moquegua','_17Pedregal','_20Mollendo','_21Puno','_22Cuzco'",
                                                               DBNull.Value, DBNull.Value, DBNull.Value, DBNull.Value))
                '' "'JULIACA','CAMANA','MOQUEGUA','EL PEDREGAL','AGENCIA MOLLENDO','AGENCIA PUNO','CUSCO'",
                '' 
                SubTitulo = "Reporte Por Sucursales"
            ElseIf rbReporteVendedorCampo.Checked Then
                oReporte = oReporte2
                sr = New StringReader(IBCMaestro.EjecutarVista("fac.spVentasDiamanteComercializadoraPromedioVendedorGeneral", dtpFechaInicioAño.Value, dtpFechaFinAño.Value, dtpFechaInicioMes.Value, dtpFechaFinMes.Value, dtpFechaInicioMes1.Value, dtpFechaFinMes1.Value, dtpMesInicio.Value, dtpMesFin.Value, dtpMesInicio1.Value, dtpMesFin1.Value,
                                                               "'_10AlejoCondoriNelidaPatricia','_07JuarezQuispeRosmery','_12MercadoMachacaChristianFreddyAndres','_11ParedesZegarraIsraelGilberto','_08TorricoParedesKresmyrBrynner','_14MartinezArceMichel','_30(NO USAR) DURAND RODRIGUEZ JONY (2)','_31APAZA ROCHA MARCO ANTONIO1','_32ARGUEDAS QUISPE ANA PAULA','_33CAYHUACAS GALLEGOS  WALTER','_34DURAND RODRIGUEZ JOHNNY MILTHON (VTAS)','_35TAMAYO RODRIGUEZ ABIGAIL CANDELARIA','_36PUMA VILLASANTE JUAN  CARLOS'",
                                                               DBNull.Value, DBNull.Value, DBNull.Value, DBNull.Value))
                '' "'ALEJO CONDORI NELIDA PATRICIA','ARGUEDAS QUISPE ANA PAULA','DURAND RODRIGUEZ JOHNNY MILTHON (VTAS) ','JUAREZ QUISPE ROSMERY ','MERCADO MACHACA CHRISTIAM FREDDY ANDRES','PAREDES ZEGARRA ISRAEL GILBERTO','TORRICO PAREDES KRESMYR BRYNNER','Zamudio Carbajal Danysoled','Martinez Arce Michel','Flores Escarza Darwin Felipe'",
                '' "'10AlejoCondoriNelidaPatricia',09DurandRodriguezJohnnyMilthon','07JuarezQuispeRosmery','12MercadoMachacaChristianFreddyAndres','11ParedesZegarraIsraelGilberto','08TorricoParedesKresmyrBrynner','13ZamudioCarbajalDanysoled','14MartinezArceMichel','15FloresEscarzaDarwinFelipe'",
                SubTitulo = "Reporte Por Vendedor De Campo"
            ElseIf rbReporteVendedorOtros.Checked Then
                oReporte = oReporte2
                sr = New StringReader(IBCMaestro.EjecutarVista("fac.spVentasDiamanteComercializadoraPromedioVendedorGeneral", dtpFechaInicioAño.Value, dtpFechaFinAño.Value, dtpFechaInicioMes.Value, dtpFechaFinMes.Value, dtpFechaInicioMes1.Value, dtpFechaFinMes1.Value, dtpMesInicio.Value, dtpMesFin.Value, dtpMesInicio1.Value, dtpMesFin1.Value,
                                                               "'_23Resto'",
                                                               DBNull.Value, DBNull.Value, DBNull.Value, DBNull.Value))
                SubTitulo = "Reporte Por Vendedor Otros"
            ElseIf rbReporteTipoCliente.Checked Then
                oReporte = oReporte2
                sr = New StringReader(IBCMaestro.EjecutarVista("fac.spVentasDiamanteComercializadoraPromedioTipoGeneral", dtpFechaInicioAño.Value, dtpFechaFinAño.Value, dtpFechaInicioMes.Value, dtpFechaFinMes.Value, dtpFechaInicioMes1.Value, dtpFechaFinMes1.Value, dtpMesInicio.Value, dtpMesFin.Value, dtpMesInicio1.Value, dtpMesFin1.Value, DBNull.Value, DBNull.Value, DBNull.Value, DBNull.Value))
                SubTitulo = "Reporte Por Tipo De Cliente"
            ElseIf rbReporteVentasArticulo.Checked Then
                oReporte = oReporte2
                sr = New StringReader(IBCMaestro.EjecutarVista("fac.spVentasDiamanteComercializadoraPromedioArticulosGeneral", dtpFechaInicioAño.Value, dtpFechaFinAño.Value, dtpFechaInicioMes.Value, dtpFechaFinMes.Value, dtpFechaInicioMes1.Value, dtpFechaFinMes1.Value, dtpMesInicio.Value, dtpMesFin.Value, dtpMesInicio1.Value, dtpMesFin1.Value, DBNull.Value, DBNull.Value, DBNull.Value, DBNull.Value))
                SubTitulo = "Reporte De Ventas Por Artículo"
            ElseIf rbReportePlanta.Checked Then
                oReporte = oReporte2
                sr = New StringReader(IBCMaestro.EjecutarVista("fac.spVentasDiamanteComercializadoraPromedioArticulosPlanta", dtpFechaInicioAño.Value, dtpFechaFinAño.Value, dtpFechaInicioMes.Value, dtpFechaFinMes.Value, dtpFechaInicioMes1.Value, dtpFechaFinMes1.Value, dtpMesInicio.Value, dtpMesFin.Value, dtpMesInicio1.Value, dtpMesFin1.Value, DBNull.Value, DBNull.Value, DBNull.Value, DBNull.Value))
                SubTitulo = "Reporte De Ventas Por Artículo En Planta"
            ElseIf rbReporteAgenciaSucursales.Checked Then
                oReporte = oReporte3
                sr = New StringReader(IBCMaestro.EjecutarVista("fac.spVentasDiamanteComercializadoraPromedioArticulosNoPlanta", dtpFechaInicioAño.Value, dtpFechaFinAño.Value, dtpFechaInicioMes.Value, dtpFechaFinMes.Value, dtpFechaInicioMes1.Value, dtpFechaFinMes1.Value, dtpMesInicio.Value, dtpMesFin.Value, dtpMesInicio1.Value, dtpMesFin1.Value,
                                                               "'_02Apacheta','_04McalCastilla','_03ConoNorte','_06Cayma','_05Umacollo','_24CerroColorado','_19Juliaca','_16Camana','_18Moquegua','_17Pedregal','_20Mollendo','_21Puno','_22Cuzco'",
                                                               DBNull.Value, DBNull.Value, DBNull.Value, DBNull.Value))

                ''"'02Apacheta','04McalCastilla','03ConoNorte','06Cayma','05Umacollo','19Juliaca','16Camana','18Moquegua','17Pedregal','20Mollendo','21Puno','22Cuzco'",
                SubTitulo = "Reporte De Ventas Por Artículo En Agencias/Sucursales"
            End If
            ...
            If vcontrol <> -1 Then
                ...
                ElseIf rbReporteAgenciaSucursales.Checked Then
                    ...
                    oReporte.Database.Tables(0).SetDataSource(ds.Tables(0))
                End If
                oReporte.DataDefinition.FormulaFields("SubTitulo").Text = "'" & SubTitulo & "'"
                oReporte.DataDefinition.FormulaFields("Anio1").Text = "'" & Year(dtpFechaInicioAño.Value) & "'"
                oReporte.DataDefinition.FormulaFields("Anio2").Text = "'" & Year(dtpFechaInicioMes1.Value) & "'"
                oReporte.DataDefinition.FormulaFields("Mes").Text = "'" & MonthName(Month(dtpMesInicio.Value)) & "'"
                oReporte.DataDefinition.FormulaFields("Mes1").Text = "'" & MonthName(Month(dtpMesInicio1.Value)) & "'"
                oReporte.refresh()
        ...
        Private Sub ColocarFechas()
            dtpFechaInicioAño.Text = Convert.ToDateTime(CStr(Year(dtpFecha.Value) - 1) & "/01" & "/01")
            dtpFechaFinAño.Text = Convert.ToDateTime(CStr(Year(dtpFecha.Value) - 1) & "/12" & "/31")

            dtpFechaInicioMes.Text = Convert.ToDateTime(CStr(Year(dtpFecha.Value) - 1) & "/" & CStr(dtpFecha.Value.Month) & "/01")
            If CStr(Year(dtpFecha.Value) - 1) & "/" & CStr(dtpFecha.Value.Month) & "/" & CStr(DateTime.DaysInMonth(dtpFecha.Value.Year, dtpFecha.Value.Month)) = "2015/2/29" Then
                dtpFechaFinMes.Text = "2015/02/28"
            Else
                dtpFechaFinMes.Text = Convert.ToDateTime(CStr(Year(dtpFecha.Value) - 1) & "/" & CStr(dtpFecha.Value.Month) & "/" & CStr(DateTime.DaysInMonth(dtpFecha.Value.Year, dtpFecha.Value.Month)))
            End If


            dtpFechaInicioMes1.Text = Convert.ToDateTime(CStr(Year(dtpFecha.Value)) & "/01" & "/01")
            dtpFechaFinMes1.Text = Convert.ToDateTime(CStr(Year(dtpFecha.Value)) & "/" & CStr(dtpFecha.Value.Month) & "/" & CStr(DateTime.DaysInMonth(dtpFecha.Value.Year, dtpFecha.Value.Month)))

            dtpMesInicio.Text = Convert.ToDateTime(CStr(Year(dtpFecha.Value)) & "/" & CStr(dtpFecha.Value.Month) & "/01")
            dtpMesFin.Text = Convert.ToDateTime(CStr(Year(dtpFecha.Value)) & "/" & CStr(dtpFecha.Value.Month) & "/" & CStr(DateTime.DaysInMonth(dtpFecha.Value.Year, dtpFecha.Value.Month)))

            If dtpFecha.Value.Month - 1 = 0 Then
                dtpMesInicio1.Text = Convert.ToDateTime(CStr(Year(dtpFecha.Value) - 1) & "/12/01")
                dtpMesFin1.Text = Convert.ToDateTime(CStr(Year(dtpFecha.Value) - 1) & "/12/31")
            Else
                dtpMesInicio1.Text = Convert.ToDateTime(CStr(Year(dtpFecha.Value)) & "/" & CStr(dtpFecha.Value.Month - 1) & "/01")
                dtpMesFin1.Text = Convert.ToDateTime(CStr(Year(dtpFecha.Value)) & "/" & CStr(dtpFecha.Value.Month - 1) & "/" & CStr(DateTime.DaysInMonth(dtpFecha.Value.Year, dtpFecha.Value.Month - 1)))
            End If
        End Sub
