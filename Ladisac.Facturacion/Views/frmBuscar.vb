...
Namespace Ladisac.Despacho.Views
    Public Class frmBuscar
        ...
        <Dependency()> _
        Public Property BCListaPrecio As Ladisac.BL.IBCListaPreciosArticulos
        <Dependency()> _
            ...
            Try
                ...
                Select Case Tabla
                    Case "Sancion"
                        ...
                        query = Me.BCSancion.ListaSancion
                    Case "FaltaSancion"
                        Me.lblTitle.Text = "Busqueda Almacen"
                        query = Me.BCFaltaSancion.ListaFaltaSancion
                    ...
                    Case "ArticuloOTSumins"
                        ...
                        If ds.Tables.Count > 0 Then ds = Me.BCArticulo.ListaArticuloSumins(mArt_Id)
                    Case "Persona"
                        Me.lblTitle.Text = "Busqueda"
                        query = Me.BCPersona.ListaPersona(Tipo, Filtro)
                    Case "OrdenTrabajo"
                    ...
                    Case "OrdenRequerimientoLadrillo"
                        Me.lblTitle.Text = "Busqueda Orden de Requerimiento"
                        ds = Me.BCOrdenRequerimiento.ListaORLadrillo(Tipo)
                    Case "OrdenCompra"
                    ...
                    Case "PuntoventaXUsu_Id"
                        Me.lblTitle.Text = "Busqueda Punto de Venta por Usuario"
                        query = Me.BCPuntoVenta.ListaPuntoVentaXUsu_Id(Tipo)
                    Case "Pesaje"
                        Me.lblTitle.Text = "Busqueda Pesaje de Balanza"
                        query = Me.BCOrdenDespacho.ListaPesaje(Tipo)
                    Case "PlacaPesaje"
                        Me.lblTitle.Text = "Busqueda Placas de Balanza"
                        query = Me.BCOrdenDespacho.ListaPlacaPesaje(Tipo)
                    Case "LadrilloDespacho"
                        Me.lblTitle.Text = "Busqueda Ladrillo"
                        query = Me.BCOrdenDespacho.ListaLadrilloDespacho
                    Case "CronogramaXdespachar"
                        Me.lblTitle.Text = "Busqueda Cronograma"
                        query = Me.BCOrdenDespacho.ListaCronogramaXdespachar(Tipo)
                    Case "OrdenDespacho"
                        Me.lblTitle.Text = "Busqueda Orden Despacho"
                        query = Me.BCOrdenDespacho.ListaOrdenDespacho
                    Case "ListaPrecioArticulo"
                        Me.lblTitle.Text = "Busqueda Lista Precio Articulo"
                        query = Me.BCListaPrecio.spListaPrecioArticulo(Tipo, Art_Id, Tipo2)
                    Case "SolicitudAjustePrecio"
                        Me.lblTitle.Text = "Busqueda Solicitud Ajuste Precio"
                        query = Me.BCSolicitudAjustePrecio.ListaSolicitudAjustePrecio
                End Select
        ...
        Private Sub dgvLista_CellDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvLista.CellDoubleClick
            If dgvLista.RowCount > 0 Then
                Select Case Tabla
                    Case "ListaPrecioArticulo"
                        If dgvLista.Columns(dgvLista.CurrentCell.ColumnIndex).Name = "Precio" Or dgvLista.Columns(dgvLista.CurrentCell.ColumnIndex).Name = "PrecioIncEnvio" Then
                            Me.DialogResult = Windows.Forms.DialogResult.OK
                            Me.Close()
                        Else
                            MessageBox.Show("Seleccione con Doble Click alguno de los dos precios (Precio or PrecioIncEnvio).")
                        End If
                    Case Else
                        Me.DialogResult = Windows.Forms.DialogResult.OK
                        Me.Close()
