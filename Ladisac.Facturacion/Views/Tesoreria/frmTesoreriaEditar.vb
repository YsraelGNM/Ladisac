...
Namespace Ladisac.Tesoreria.Views
    Public Class frmTesoreriaEditar

        <Dependency()>
        Public Property SessionService As Ladisac.Foundation.Services.ISessionService

        <Dependency()> _
        Public Property IBCTesoreriaEditar As Ladisac.BL.IBCTesoreriaEditar
        ...
        Private EchkTES_FECHA_EMI As New chk
        Private EchkTEE_NO_CAJERO As New chk
        Private EchkTEE_ESTADO As New chk

        Private EtxtPEU_ID As New txt

        Private Simple As New Ladisac.BE.TesoreriaEditar
        Private Simple1 As New Ladisac.BE.PermisoUsuario
        Private ErrorData As New Ladisac.BE.TesoreriaEditar.ErrorData
        ...
        Private Sub LimpiarDatos()
            txtTEE_USU_ID.Text = ""
            ErrorProvider1.SetError(txtTEE_USU_ID, Nothing)
            ...
            chkUSU_ESTADO.Checked = Nothing
            chkUSU_ESTADO.CheckState = EchkUSU_ESTADO.pValorDefault
            ErrorProvider1.SetError(chkUSU_ESTADO, Nothing)

            chkTES_FECHA_EMI.Checked = Nothing
            chkTES_FECHA_EMI.CheckState = EchkTES_FECHA_EMI.pValorDefault
            ErrorProvider1.SetError(chkTES_FECHA_EMI, Nothing)

            chkTEE_NO_CAJERO.Checked = Nothing
            chkTEE_NO_CAJERO.CheckState = EchkTEE_NO_CAJERO.pValorDefault
            ErrorProvider1.SetError(chkTEE_NO_CAJERO, Nothing)

            chkTEE_ESTADO.Checked = Nothing
            chkTEE_ESTADO.CheckState = EchkTEE_ESTADO.pValorDefault
            ErrorProvider1.SetError(chkTEE_ESTADO, Nothing)
        End Sub
        Private Sub HabilitarNuevo()
            txtTEE_USU_ID.Enabled = True
        End Sub
        Private Sub ValoresDefaultNuevo()
            ColocarValoresDefault(chkUSU_ESTADO)
            ColocarValoresDefault(chkTES_FECHA_EMI)
            ColocarValoresDefault(chkTEE_NO_CAJERO)
            ColocarValoresDefault(chkTEE_ESTADO)
        End Sub
        Public Sub ColocarValoresDefault(ByVal vObjeto As CheckBox)
            ...
            Select Case vObjeto.Name
                ...
                Case "chkTES_FECHA_EMI"
                    vObjetoChk.pValorDefault = EchkTES_FECHA_EMI.pValorDefault
                Case "chkTEE_NO_CAJERO"
                    vObjetoChk.pValorDefault = EchkTEE_NO_CAJERO.pValorDefault
                Case "chkTEE_ESTADO"
                    vObjetoChk.pValorDefault = EchkTEE_ESTADO.pValorDefault
            End Select
        ...
        Private Sub OrmBusquedaDatos(ByVal vProceso As String)
            Select Case vProceso
                ...
                Case "EliminarRegistro"
                    Simple.TEE_USU_ID = txtTEE_USU_ID.Text.Trim
                    CodigoId = txtTEE_USU_ID.Text.Trim
        ...
        Private Function Ingresar() As Boolean
            ...
            End If
            Simple = Nothing
            Simple = New Ladisac.BE.TesoreriaEditar
            Return Ingresar
        End Function
        Private Sub DatosCabecera()
            Dim vTEE_USU_ID As String = ""
            vTEE_USU_ID = Strings.Trim(txtTEE_USU_ID.Text)
            Simple.TEE_USU_ID = vTEE_USU_ID
            Simple.PVE_ID = Nothing
            Simple.TES_SERIE = Nothing
            Simple.TES_FECHA_EMI = DevolverTiposCampos(chkTES_FECHA_EMI)
            Simple.TEE_NO_CAJERO = DevolverTiposCampos(chkTEE_NO_CAJERO)
            Simple.USU_ID = SessionService.UserId
            Simple.TEE_FEC_GRAB = Now
            Simple.TEE_ESTADO = DevolverTiposCampos(chkTEE_ESTADO)
        End Sub
        Private Function DevolverTiposCampos(ByRef oObjeto As CheckBox) As String
            Select Case oObjeto.Name.ToString
                Case "chkUSU_ESTADO"
                    Simple.CampoId = EchkUSU_ESTADO.pNombreCampo
                    Simple.Dato = oObjeto.Text
                Case "chkTES_FECHA_EMI"
                    Simple.CampoId = EchkTES_FECHA_EMI.pNombreCampo
                    Simple.Dato = oObjeto.Text
                Case "chkTEE_NO_CAJERO"
                    Simple.CampoId = EchkTEE_NO_CAJERO.pNombreCampo
                    Simple.Dato = oObjeto.Text
                Case "chkTEE_ESTADO"
                    Simple.CampoId = EchkTEE_ESTADO.pNombreCampo
                    Simple.Dato = oObjeto.Text
            End Select
        ...
        Private Function Validar(ByVal vModelos As String) As Boolean
            ...
            Select Case vModelos
                Case "Cabecera"
                    resp.rM = Simple.ColocarErrores(txtTEE_USU_ID, Simple.VerificarDatos("TEE_USU_ID"), ErrorProvider1)
                    resp.rM = Simple.ColocarErrores(chkTES_FECHA_EMI, Simple.VerificarDatos("TES_FECHA_EMI"), ErrorProvider1)
                    resp.rM = Simple.ColocarErrores(chkTEE_NO_CAJERO, Simple.VerificarDatos("TEE_NO_CAJERO"), ErrorProvider1)

                    resp.rM = Simple.ColocarErrores(lblTitle, Simple.VerificarDatos("TEE_ID"), ErrorProvider1)
                    resp.rM = Simple.ColocarErrores(lblTitle, Simple.VerificarDatos("TEE_FEC_GRAB"), ErrorProvider1)
                    resp.rM = Simple.ColocarErrores(chkTEE_ESTADO, Simple.VerificarDatos("TEE_ESTADO"), ErrorProvider1)
            End Select
            Return vrO
        End Function
        Private Function InsertarDatos() As Boolean
            ...
            Simple.MarkAsAdded()
            vRespuestaLocal = Me.IBCTesoreriaEditar.Mantenimiento(Simple)
        ...
        Private Function ActualizarDatos() As Boolean
            ...
            ActualizarDatos = (Me.IBCTesoreriaEditar.Mantenimiento(Simple) > 0)
        End Function
        ...
        Private Function EliminarRegistro() As Boolean
            ...
            If (Me.IBCTesoreriaEditar.Mantenimiento(Simple) > 0) Then
        ...
        Protected Overrides Function ProcessDialogKey(ByVal keyData As System.Windows.Forms.Keys) As Boolean
            If keyData = Keys.Enter Then
                If Me.ActiveControl.Name.ToString = "txtTEE_USU_ID" Then EtxtPEU_ID.pTexto2 = Me.ActiveControl.Text
        ...
        Private Sub frm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) _
            ...
            Try
                ...
                FormatearCampos(txtTEE_USU_ID, "TEE_USU_ID")
        ...
        Private Sub ConfigurarCheck()
            ...
            EchkUSU_ESTADO.pSimple = Simple
            EchkUSU_ESTADO.pValorDefault = CheckState.Checked
            EchkUSU_ESTADO.vEstado0 = ""
            EchkUSU_ESTADO.vEstado1 = ""
            EchkUSU_ESTADO.vEstadoX = ""
            ConfigurarCheck_Refrescar(EchkUSU_ESTADO)

            EchkTES_FECHA_EMI.pFormatearTexto = True
            EchkTES_FECHA_EMI.pNombreCampo = "TES_FECHA_EMI"
            EchkTES_FECHA_EMI.pSimple = Simple
            EchkTES_FECHA_EMI.pValorDefault = CheckState.Checked
            EchkTES_FECHA_EMI.vEstado0 = ""
            EchkTES_FECHA_EMI.vEstado1 = ""
            EchkTES_FECHA_EMI.vEstadoX = ""
            ConfigurarCheck_Refrescar(EchkTES_FECHA_EMI)

            EchkTEE_NO_CAJERO.pFormatearTexto = True
            EchkTEE_NO_CAJERO.pNombreCampo = "TEE_NO_CAJERO"
            EchkTEE_NO_CAJERO.pSimple = Simple
            EchkTEE_NO_CAJERO.pValorDefault = CheckState.Checked
            EchkTEE_NO_CAJERO.vEstado0 = ""
            EchkTEE_NO_CAJERO.vEstado1 = ""
            EchkTEE_NO_CAJERO.vEstadoX = ""
            ConfigurarCheck_Refrescar(EchkTEE_NO_CAJERO)

            EchkTEE_ESTADO.pFormatearTexto = True
            EchkTEE_ESTADO.pNombreCampo = "TEE_ESTADO"
            EchkTEE_ESTADO.pSimple = Simple
            EchkTEE_ESTADO.pValorDefault = CheckState.Checked
            EchkTEE_ESTADO.vEstado0 = ""
            EchkTEE_ESTADO.vEstado1 = ""
            EchkTEE_ESTADO.vEstadoX = ""
            ConfigurarCheck_Refrescar(EchkTEE_ESTADO)
        End Sub
        ...
        Private Sub InicializarTexto(ByVal vObjeto As chk)
            Select Case vObjeto.pNombreCampo
                Case "USU_ESTADO"
                    ...
                    End With
                Case "TES_FECHA_EMI"
                    With chkTES_FECHA_EMI
                        If .CheckState = CheckState.Checked Then .Text = vObjeto.vEstado1
                        If .CheckState = CheckState.Unchecked Then .Text = vObjeto.vEstado0
                        If .CheckState = CheckState.Indeterminate Then .Text = vObjeto.vEstadoX
                    End With
                Case "TEE_NO_CAJERO"
                    With chkTEE_NO_CAJERO
                        If .CheckState = CheckState.Checked Then .Text = vObjeto.vEstado1
                        If .CheckState = CheckState.Unchecked Then .Text = vObjeto.vEstado0
                        If .CheckState = CheckState.Indeterminate Then .Text = vObjeto.vEstadoX
                    End With
        ...
        Public Sub Check_Refrescar()
            ...
            InicializarTexto(EchkTES_FECHA_EMI)
            InicializarTexto(EchkTEE_NO_CAJERO)
            InicializarTexto(EchkTEE_ESTADO)
        End Sub
        Private Sub ConfigurarText()
            ...
            EtxtPEU_ID.pOOrm = Nothing
            EtxtPEU_ID.pFormularioConsulta = Nothing

            EtxtPEU_ID.pComportamiento = Nothing
        ...
        Private Sub txt_OnKeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) _
           Handles txtTEE_USU_ID.KeyDown
            Select Case e.KeyCode
                Case Keys.F1
                    Select Case sender.name.ToString
                        Case "txtTEE_USU_ID"
                            TeclaF1(EtxtPEU_ID, txtTEE_USU_ID)
                    End Select
            End Select
        End Sub
...
#Region "TextBox"
        ...
        Handles txtTEE_USU_ID.GotFocus
            Select Case sender.name.ToString
                Case "txtTEE_USU_ID"
        ...
        Handles txtTEE_USU_ID.LostFocus
            Select Case sender.name.ToString
                Case "txtTEE_USU_ID"
        ...
        Handles txtTEE_USU_ID.DoubleClick
            Select Case sender.name.ToString
                Case "txtTEE_USU_ID"
                    ''oDoubleClick(EtxtPEU_ID, txtTEE_USU_ID, "frmCajaCtaCte")
            End Select
        End Sub
...
#End Region
        ...
        Private Sub chk_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) _
            Handles chkUSU_ESTADO.CheckedChanged, _
                    chkTES_FECHA_EMI.CheckedChanged, _
                    chkTEE_NO_CAJERO.CheckedChanged, _
                    chkTEE_ESTADO.CheckedChanged
            Select Case sender.name.ToString
                Case "chkUSU_ESTADO"
                    ...
                    End If
                Case "chkTES_FECHA_EMI"
                    If EchkTES_FECHA_EMI.pFormatearTexto Then
                        InicializarTexto(EchkTES_FECHA_EMI)
                    End If
                Case "chkTEE_NO_CAJERO"
                    If EchkTEE_NO_CAJERO.pFormatearTexto Then
                        InicializarTexto(EchkTEE_NO_CAJERO)
                    End If
                Case "chkTEE_ESTADO"
                    If EchkTEE_ESTADO.pFormatearTexto Then
                        InicializarTexto(EchkTEE_ESTADO)
                    End If
            End Select
        End Sub
