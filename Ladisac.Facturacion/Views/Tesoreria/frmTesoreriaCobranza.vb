...
Namespace Ladisac.Tesoreria.Views
    Public Class frmTesoreriaCobranza
        <Dependency()> _
        ...
        <Dependency()> _
        Public Property IBCTesoreriaCobranza As Ladisac.BL.IBCTesoreriaCobranza
        ...
        Private vItemKardexCtaCteDudosa As Integer

        Private EchkTEC_ESTADO As New chk

        Private EtxtPER_ID_CLIx As New txt
        Private EtxtDTD_IDx As New txt

        ' DateTimePicker
        Private EdtpTEC_FECHA_EMI As New dtp

        Private Simple As New Ladisac.BE.TesoreriaCobranza
        Private Simple1 As New Ladisac.BE.KardexCtaCte

        Private ErrorData As New Ladisac.BE.TesoreriaCobranza.ErrorData
        ...
        Public vCodigoTEC_SERIE As String = ""
        Public vCodigoTEC_NUMERO As String = ""
        ...
        Public Sub PrepararGuardar(ByVal vNuevo As Boolean)
            ...
            vFechaDocumento = dtpTEC_FECHA_EMI.Value
            ...
            vItemKardexCtaCteDudosa = Me.IBCKardexCtaCte.ItemKardexCtaCteDudosa(txtTDO_ID.Text, txtDTD_ID.Text, txtTEC_SERIE.Text, txtTEC_NUMERO.Text, txtPER_ID_CLI.Text)
        ...
        Private Sub LimpiarDatos()
            dtpTEC_FECHA_EMI.Value = Today
            ErrorProvider1.SetError(dtpTEC_FECHA_EMI, Nothing)

            chkTEC_ESTADO.Checked = Nothing
            chkTEC_ESTADO.CheckState = EchkTEC_ESTADO.pValorDefault
            ErrorProvider1.SetError(chkTEC_ESTADO, Nothing)
            ...
            txtTEC_SERIE.Text = ""
            ErrorProvider1.SetError(txtTEC_SERIE, Nothing)

            txtTEC_NUMERO.Text = ""
            ErrorProvider1.SetError(txtTEC_NUMERO, Nothing)
            ...
            txtTEC_MONTO.Text = "0.00"
            ErrorProvider1.SetError(txtTEC_MONTO, Nothing)
            ...
            Try
                ...
                Select Case vProceso
                    Case "CancelarEdicion"
                        ...
                        End If
                    Case "PrepararEliminar"
                        Simple.CampoPrincipalValor = CodigoId & vCodigoDTD_ID & vCodigoTEC_SERIE & vCodigoTEC_NUMERO
        ...
        Public Sub OrmBusquedaDatos(ByVal vProceso As String)
            Select Case vProceso
                Case "CancelarEdicion"
                    CodigoId = CodigoId & vCodigoDTD_ID & vCodigoTEC_SERIE & vCodigoTEC_NUMERO
                    If Trim(CodigoId) = "" Then CodigoId = "%"
                Case "PrepararEliminar"
                    Simple.Vista = "RegistroAnterior"
                    Simple.TDO_ID = CodigoId
                    Simple.DTD_ID = vCodigoDTD_ID
                    Simple.TEC_SERIE = vCodigoTEC_SERIE
                    Simple.TEC_NUMERO = vCodigoTEC_NUMERO
                ...
                Case "RegistroNoEncontrado" ' ojito
                    ...
                    Simple.TEC_SERIE = txtTEC_SERIE.Text.Trim
                    Simple.TEC_NUMERO = txtTEC_NUMERO.Text.Trim
                    Simple.PER_ID_CLI = txtPER_ID_CLI.Text.Trim

                    CodigoId = Simple.TDO_ID
                    vCodigoDTD_ID = Simple.DTD_ID
                    vCodigoTEC_SERIE = Simple.TEC_SERIE
                    vCodigoTEC_NUMERO = Simple.TEC_NUMERO
                ...
                Case "EliminarRegistro"
                    ...
                    Simple.TEC_SERIE = txtTEC_SERIE.Text.Trim
                    vCodigoTEC_SERIE = txtTEC_SERIE.Text.Trim

                    Simple.TEC_NUMERO = txtTEC_NUMERO.Text.Trim
                    vCodigoTEC_NUMERO = txtTEC_NUMERO.Text.Trim

                    Simple.PER_ID_CLI = txtPER_ID_CLI.Text.Trim

                    Simple.TEC_FECHA_EMI = dtpTEC_FECHA_EMI.Value
        ...
        Private Sub DatosCabecera()
            ...
            Simple.TEC_SERIE = Strings.Trim(txtTEC_SERIE.Text)
            Simple.TEC_NUMERO = Strings.Trim(txtTEC_NUMERO.Text)
            Simple.TEC_FECHA_EMI = dtpTEC_FECHA_EMI.Value
            Simple.PER_ID_CLI = Strings.Trim(txtPER_ID_CLI.Text)
            Simple.MON_ID = Strings.Trim(txtMON_ID.Text)
            Simple.TEC_MONTO = CDbl(txtTEC_MONTO.Text)
            Simple.USU_ID = SessionService.UserId
            Simple.TEC_FEC_GRAB = Now
            Simple.TEC_ESTADO = DevolverTiposCampos(chkTEC_ESTADO)
        End Sub
        Private Function DevolverTiposCampos(ByRef oObjeto As CheckBox) As String
            Select Case oObjeto.Name.ToString
                Case "chkTEC_ESTADO"
                    Simple.CampoId = EchkTEC_ESTADO.pNombreCampo
        ...
        Private Function Validar(ByVal vModelos As String) As Boolean
            ...
            Select Case vModelos
                Case "Cabecera"
                    ...
                    resp.rM = Simple.ColocarErrores(txtTEC_SERIE, Simple.VerificarDatos("TEC_SERIE"), ErrorProvider1)
                    resp.rM = Simple.ColocarErrores(txtTEC_NUMERO, Simple.VerificarDatos("TEC_NUMERO"), ErrorProvider1)
                    resp.rM = Simple.ColocarErrores(dtpTEC_FECHA_EMI, Simple.VerificarDatos("TEC_FECHA_EMI"), ErrorProvider1)
                    ...
                    resp.rM = Simple.ColocarErrores(txtTEC_MONTO, Simple.VerificarDatos("TEC_MONTO"), ErrorProvider1)

                    resp.rM = Simple.ColocarErrores(pnCuerpo, Simple.VerificarDatos("USU_ID"), ErrorProvider1)
                    resp.rM = Simple.ColocarErrores(btnImagen, Simple.VerificarDatos("TEC_FEC_GRAB"), ErrorProvider1)
                    resp.rM = Simple.ColocarErrores(chkTEC_ESTADO, Simple.VerificarDatos("TEC_ESTADO"), ErrorProvider1)
            End Select
            Return vrO
        End Function
        Private Function InsertarDatos() As Boolean
            ...
            vRespuestaLocal = IBCTesoreriaCobranza.spInsertarRegistro(Simple.TDO_ID, Simple.DTD_ID, Simple.CCT_ID, Simple.TEC_SERIE, Simple.TEC_NUMERO, Simple.TEC_FECHA_EMI, Simple.PER_ID_CLI, Simple.MON_ID, Simple.TEC_MONTO, Simple.USU_ID, Simple.TEC_FEC_GRAB, Simple.TEC_ESTADO)
        ...
        Private Function ActualizarDatos() As Boolean
            ...
            vEliminarRegistroKardexCtaCte = EliminarKardexCtaCteDudosa(vItemKardexCtaCteDudosa)
            ActualizarDatos = (Me.IBCTesoreriaCobranza.spActualizarRegistro(Simple.TDO_ID, Simple.DTD_ID, Simple.CCT_ID, Simple.TEC_SERIE, Simple.TEC_NUMERO, Simple.TEC_FECHA_EMI, Simple.PER_ID_CLI, Simple.MON_ID, Simple.TEC_MONTO, Simple.USU_ID, Simple.TEC_FEC_GRAB, Simple.TEC_ESTADO) > 0 And vEliminarRegistroKardexCtaCte = 1)
        End Function

        Private Function EliminarKardexCtaCteDudosa(ByVal vItem As Integer)
            EliminarKardexCtaCteDudosa = 0
            If vItem < 1 Then
                EliminarKardexCtaCteDudosa = 1
            Else
                For fila = 1 To vItem
                    EliminarKardexCtaCteDudosa = Me.IBCKardexCtaCte.spEliminarRegistroCobranza(fila, Simple.TDO_ID & Simple.DTD_ID & Simple.TEC_SERIE & Simple.TEC_NUMERO, Simple.PER_ID_CLI)
                    If EliminarKardexCtaCteDudosa = 0 Then
                        Exit For
                    End If
                Next
            End If
            Return EliminarKardexCtaCteDudosa
        End Function
        ...
        Private Function EliminarRegistro() As Boolean
            ...
            Using Scope As New System.Transactions.TransactionScope()
                ...
                If (Me.IBCTesoreriaCobranza.spEliminarRegistro(Simple.TDO_ID, Simple.DTD_ID, Simple.TEC_SERIE, Simple.TEC_NUMERO, Simple.PER_ID_CLI) > 0 And vEliminarRegistroKardexCtaCte = 1) Then
                    Scope.Complete()
        ...
        Private Sub ConfigurarCheck()
            EchkTEC_ESTADO.pFormatearTexto = True
            EchkTEC_ESTADO.pNombreCampo = "TEC_ESTADO"
            EchkTEC_ESTADO.pSimple = Simple
            EchkTEC_ESTADO.pValorDefault = CheckState.Checked
            EchkTEC_ESTADO.vEstado0 = ""
            EchkTEC_ESTADO.vEstado1 = ""
            EchkTEC_ESTADO.vEstadoX = ""
            ConfigurarCheck_Refrescar(EchkTEC_ESTADO)
        End Sub
        ...
        Public Sub Check_Refrescar()
            InicializarTexto(EchkTEC_ESTADO)
        End Sub
        ...
        Public Sub FiltrarCampos(ByVal vComportamiento As Integer)
            ...
            End Select
            vTec_Monto = CDbl(txtTEC_MONTO.Text)
            txtTEC_MONTO.Text = Format(vTec_Monto, "##,###.###0")
        End Sub
...
#End Region
        ...
        Private Sub chk_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) _
            Handles chkTEC_ESTADO.CheckedChanged
            Select Case sender.name.ToString
                Case "chkTEC_ESTADO"
                    If EchkTEC_ESTADO.pFormatearTexto Then
                        InicializarTexto(EchkTEC_ESTADO)
                    End If
            End Select
        End Sub
        ...
        Private Sub DataTimePcker_DropDown(ByVal sender As System.Object, ByVal e As System.EventArgs) _
            Handles dtpTEC_FECHA_EMI.DropDown
            VerificarDatosSession()
            Select Case sender.name
                Case "dtpTEC_FECHA_EMI"
                    If Not EdtpTEC_FECHA_EMI.pEnabled Then
                        dtpTEC_FECHA_EMI.MaxDate = dtpTEC_FECHA_EMI.Value
                        dtpTEC_FECHA_EMI.MinDate = dtpTEC_FECHA_EMI.Value
                    Else
                    End If
            End Select
        End Sub
        Private Sub VerificarDatosSession()
            EdtpTEC_FECHA_EMI.pEnabled = SessionService.ModificarFechaProcesoEnTesoreria
        End Sub

        Private Sub ConfigurarDateTimePicker()
            Dim EdtpTemporal As New dtp
            EdtpTemporal.pNombreCampo = "TEC_FECHA_EMI"
            EdtpTemporal.pEnabled = False
            EdtpTemporal.pBusqueda = False
            EdtpTemporal.pFormat = DateTimePickerFormat.Short
            EdtpTEC_FECHA_EMI = EdtpTemporal
        End Sub
