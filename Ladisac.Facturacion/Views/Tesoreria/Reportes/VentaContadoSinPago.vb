...
Public Class VentaContadoSinPago
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "VentaContadoSinPago.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentaContadoSinPago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentaContadoSinPago = New VentaContadoSinPago()
        rpt.Site = Me.Site
        Return rpt
    End Function
