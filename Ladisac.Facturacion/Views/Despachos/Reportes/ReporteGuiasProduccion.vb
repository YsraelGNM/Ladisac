...
Public Class ReporteGuiasProduccion
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReporteGuiasProduccion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteGuiasProduccion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteGuiasProduccion = New ReporteGuiasProduccion()
        rpt.Site = Me.Site
        Return rpt
    End Function
