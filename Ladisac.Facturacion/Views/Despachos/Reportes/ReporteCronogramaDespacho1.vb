...
Public Class ReporteCronogramaDespacho
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReporteCronogramaDespacho.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteCronogramaDespacho
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteCronogramaDespacho = New ReporteCronogramaDespacho()
        rpt.Site = Me.Site
        Return rpt
    End Function
