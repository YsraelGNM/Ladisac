...
Public Class TrasladoEntreAlmacenes
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "TrasladoEntreAlmacenes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTrasladoEntreAlmacenes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TrasladoEntreAlmacenes = New TrasladoEntreAlmacenes()
        rpt.Site = Me.Site
        Return rpt
    End Function
