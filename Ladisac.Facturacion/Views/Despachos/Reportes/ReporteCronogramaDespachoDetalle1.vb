...
Public Class ReporteCronogramaDespachoDetalle
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "ReporteCronogramaDespachoDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DES_ESTADO() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporteCronogramaDespachoDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteCronogramaDespachoDetalle = New ReporteCronogramaDespachoDetalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
