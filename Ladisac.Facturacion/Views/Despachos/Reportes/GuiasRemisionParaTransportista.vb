...
Public Class GuiasRemisionParaTransportista
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "GuiasRemisionParaTransportista.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGuiasRemisionParaTransportista
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GuiasRemisionParaTransportista = New GuiasRemisionParaTransportista()
        rpt.Site = Me.Site
        Return rpt
    End Function
