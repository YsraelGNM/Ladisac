...
Public Class KardexDocumentoDespacho
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "KardexDocumentoDespacho.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedKardexDocumentoDespacho
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As KardexDocumentoDespacho = New KardexDocumentoDespacho()
        rpt.Site = Me.Site
        Return rpt
    End Function
