...
Public Class frmReporteGuiasSinDocumento
    <Dependency()> _
    Public Property BCDespacho As Ladisac.BL.IBCDespachos

    Private Sub frmReporteGuiasSinDocumento_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnVisualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVisualizar.Click
        Try
            ...
            Dim query = BCDespacho.ListaGuiasSinDocumento
            Dim rea As New StringReader(query)
            ds.ReadXml(rea)

            ReportViewer1.LocalReport.DataSources.Clear()
            ReportViewer1.LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("dsListaGuiasSinDocumento", ds.Tables(0)))
