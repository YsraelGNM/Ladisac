...
Public Class rptGuiasEnTransitoPendiente
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptGuiasEnTransitoPendiente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGuiasEnTransitoPendiente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGuiasEnTransitoPendiente = New rptGuiasEnTransitoPendiente()
        rpt.Site = Me.Site
        Return rpt
    End Function
