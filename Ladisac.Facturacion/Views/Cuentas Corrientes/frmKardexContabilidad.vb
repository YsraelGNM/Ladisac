...
Namespace Ladisac.CuentasCorrientes.Views
    Public Class frmKardexContabilidad
            ...
            Try
                ...
                Else
                    If rbFormato1.Checked Then  'If chkTipoFormato.CheckState Then
                        ...
                        NombreProcedimiento = "dbo.spKardexContabilidadXML"
                        'End If
                ...
                ElseIf rbFormato1.Checked Then
                    ...
                    Else
                        vFiltroProcedimiento = vFiltroProcedimiento & " AND CUC_ID_REF LIKE ('" & txtCUC_ID.Text & "%')  "
                    End If
                    If chkPorPeriodo.CheckState Then
                        vTitulo3 &= " - Periodo: " & txtPeriodo.Text
                        vFiltroProcedimiento = vFiltroProcedimiento & " AND (prd_Periodo_Id>='" & Strings.Left(txtPeriodo.Text, 4) & "01" & "' and prd_Periodo_Id<='" & txtPeriodo.Text & "' )   "
                    ...
                    If vcontrol <> -1 Then
                        ...
                        oReporte.DataDefinition.FormulaFields("Titulo1").Text = "'" & "Kardex Contable de la Persona" & "'"
