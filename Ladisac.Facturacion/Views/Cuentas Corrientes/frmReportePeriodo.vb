...
#Region "Declaraciones"
        ...
        Dim oReporte1 As New Retenciones
...
#End Region
        ...
        Private Sub Imprimir()
            Try
                ...
                Dim sr As Object
                sr = New StringReader(IBCMaestro.EjecutarVista("spRetencionesXML", vCadenaPeriodo, txtPER_ID.Text))
                oReporte = oReporte1
                Dim vcontrol As Int16 = sr.Peek
                If vcontrol <> -1 Then
                    ds.ReadXml(sr)
        ...
        Private Sub txt_OnGotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPER_ID.GotFocus
            Select Case sender.name.ToString
                Case "txtPER_ID"
