...
Public Class VentaDiariaFinanzas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "VentaDiariaFinanzas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVentaDiariaFinanzas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VentaDiariaFinanzas = New VentaDiariaFinanzas()
        rpt.Site = Me.Site
        Return rpt
    End Function
