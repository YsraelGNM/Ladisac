...
Namespace Ladisac.CuentasCorrientes.Reportes
    Public Class kardexNombrePersona
        ...
        Public Overrides Property ResourceName() As String
            Get
                Return "kardexNombrePersona.rpt"
            End Get
    ...
    Public Class CachedkardexNombrePersona
        Inherits Component
        ...
        Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
            Dim rpt As kardexNombrePersona = New kardexNombrePersona()
            rpt.Site = Me.Site
            Return rpt
        End Function
