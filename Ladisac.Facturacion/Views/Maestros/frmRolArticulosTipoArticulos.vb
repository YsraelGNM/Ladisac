...
Namespace Ladisac.Maestros.Views
    Public Class frmRolArticulosTipoArticulos
#Region "Primaria"
        <Dependency()>
...
#Region "Secundaria"
        <Dependency()> _
        Public Property IBC As Ladisac.BL.IBCRolArticulosTipoArticulos
...
#End Region
        ...
        Private EchkRAR_ESTADO As New chk

        Private EtxtART_ID As New txt
        Private EtxtTIP_ID As New txt

        Private Simple As New Ladisac.BE.RolArticulosTipoArticulos
        Private Simple1 As New Ladisac.BE.Articulos
        Private Simple2 As New Ladisac.BE.TipoArticulos

        Private ErrorData As New Ladisac.BE.RolArticulosTipoArticulos.ErrorData
        ...
        Private Sub LimpiarDatos()
            ...
            InicializarValores(chkRAR_ESTADO, ErrorProvider1, False, False, EchkRAR_ESTADO.pValorDefault)

            ColocarValoresDefault(chkART_ESTADO)
            ColocarValoresDefault(chkTIP_ESTADO)
            ColocarValoresDefault(chkRAR_ESTADO)
        End Sub
        ...
        Private Sub CrearCodigoId()
            'ProcesoCrearCodigoId("CrearCodigoSimple", txtART_ID1)
        End Sub
        ...
        Private Sub OrmBusquedaDatos(ByVal vProceso As String)
            Select Case vProceso
                ...
                Case "EliminarRegistro"
                    Simple.ART_ID = txtART_ID.Text.Trim
                    CodigoId = txtART_ID.Text.Trim
        ...
        Private Sub DatosCabecera()
            Simple.ART_ID = Strings.Trim(txtART_ID.Text)
            Simple.TIP_ID = Strings.Trim(txtTIP_ID.Text)
            Simple.USU_ID = SessionService.UserId
            Simple.RAR_FEC_GRAB = Now
            Simple.RAR_ESTADO = DevolverTiposCampos(chkRAR_ESTADO)
        End Sub
        Private Function Validar(ByVal vModelos As String) As Boolean
            ...
            Select Case vModelos
                Case "Cabecera"
                    resp.rM = Simple.ColocarErrores(txtART_ID, Simple.VerificarDatos("ART_ID"), ErrorProvider1)
                    ...
                    resp.rM = Simple.ColocarErrores(btnImagen, Simple.VerificarDatos("RAR_FEC_GRAB"), ErrorProvider1)
                    resp.rM = Simple.ColocarErrores(chkRAR_ESTADO, Simple.VerificarDatos("RAR_ESTADO"), ErrorProvider1)
            End Select
            Return vrO
        End Function
        Private Sub InicializarOrm()
            Simple = Nothing
            Simple = New Ladisac.BE.RolArticulosTipoArticulos
        End Sub
...
#Region "CheckBox"
        ...
        Public Sub ColocarValoresDefault(ByRef vObjeto As CheckBox)
            ...
            Select Case vObjeto.Name
                ...
                Case "chkRAR_ESTADO"
                    vObjetoChk.pValorDefault = EchkRAR_ESTADO.pValorDefault
            End Select
        ...
        Private Sub chk_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) _
            Handles chkART_ESTADO.CheckedChanged, chkTIP_ESTADO.CheckedChanged, chkRAR_ESTADO.CheckedChanged
            Select Case sender.name.ToString
                ...
                Case "chkTIP_ESTADO"
                    ...
                    End If
                Case "chkRAR_ESTADO"
                    If EchkRAR_ESTADO.pFormatearTexto Then
                        InicializarTextoCheck(EchkRAR_ESTADO)
                    End If
            End Select
        End Sub
...
#Region "Secundaria 2"
        ...
        Private Sub FiltrarOrm()
            ...
            EtxtART_ID.pOOrm.CadenaFiltrado = ""
        End Sub
#Region "ComboBox"
