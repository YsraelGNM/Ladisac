...
Namespace Ladisac.Maestros.Views
    Public Class frmProvincia
        ...
        <Dependency()> _
        Public Property IBCProvincia As Ladisac.BL.IBCProvincia
        ...
        Private EtxtDEP_ID As New txt

        Private Simple As New Ladisac.BE.Provincia
        Private ErrorData As New Ladisac.BE.Provincia.ErrorData
        ...
        Private Sub LimpiarDatos()
            ...
            txtPRO_COD_SUNAT.Text = ""
            ErrorProvider1.SetError(txtPRO_COD_SUNAT, Nothing)

            chkPRO_ESTADO.Checked = True
        ...
        Private Sub CrearCodigoId()
            ProcesoCrearCodigoId("CrearCodigoSimple", txtPRO_ID)
        End Sub
        ...
        Private Sub OrmBusquedaDatos(ByVal vProceso As String)
            Select Case vProceso
                ...
                Case "EliminarRegistro"
                    Simple.PRO_ID = txtPRO_ID.Text.Trim
                    CodigoId = txtPRO_ID.Text.Trim
        ...
        Private Function Ingresar() As Boolean
            ...
            End If
            Simple = Nothing
            Simple = New Ladisac.BE.Provincia
            Return Ingresar
        End Function
        Private Sub DatosCabecera()
            Simple.PRO_ID = Strings.Trim(txtPRO_ID.Text)
            Simple.PRO_DESCRIPCION = Strings.Trim(txtPRO_DESCRIPCION.Text)
            Simple.DEP_ID = Strings.Trim(txtDEP_ID.Text)
            Simple.PRO_COD_SUNAT = Strings.Trim(txtPRO_COD_SUNAT.Text)
            Simple.USU_ID = SessionService.UserId
            Simple.PRO_FEC_GRAB = Now
            Simple.PRO_ESTADO = DevolverTiposCampos(chkPRO_ESTADO)
        End Sub
        ...
        Private Function Validar(ByVal vModelos As String) As Boolean
            ...
            Select Case vModelos
                Case "Cabecera"
                    ...
                    resp.rM = Simple.ColocarErrores(txtPRO_DESCRIPCION, Simple.VerificarDatos("PRO_DESCRIPCION"), ErrorProvider1)
                    ...
                    resp.rM = Simple.ColocarErrores(txtPRO_COD_SUNAT, Simple.VerificarDatos("PRO_COD_SUNAT"), ErrorProvider1)
                    resp.rM = Simple.ColocarErrores(lblTitle, Simple.VerificarDatos("PRO_FEC_GRAB"), ErrorProvider1)
                    resp.rM = Simple.ColocarErrores(chkPRO_ESTADO, Simple.VerificarDatos("PRO_ESTADO"), ErrorProvider1)
            End Select
            Return vrO
        End Function
        Private Function InsertarDatos() As Boolean
            ...
            Simple.MarkAsAdded()
            vRespuestaLocal = Me.IBCProvincia.MantenimientoProvincia(Simple)
        ...
        Private Function ActualizarDatos() As Boolean
            ...
            ActualizarDatos = (Me.IBCProvincia.MantenimientoProvincia(Simple) > 0)
        End Function
        ...
        Private Function EliminarRegistro() As Boolean
            ...
            If (Me.IBCProvincia.MantenimientoProvincia(Simple) > 0) Then
                'Scope.Complete()
        ...
        Protected Overrides Function ProcessDialogKey(ByVal keyData As System.Windows.Forms.Keys) As Boolean
            If keyData = Keys.Enter Then
                If Me.ActiveControl.Name.ToString = "txtDEP_ID" Then EtxtDEP_ID.pTexto2 = Me.ActiveControl.Text
        ...
        End Function
        Private Sub frmProvincia_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) _
            ...
            End If
        End Sub
        Private Sub frmProvincia_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) _
            Handles MyBase.Load
            ...
            Try
                ...
                FormatearCampos(txtPRO_COD_SUNAT, "PRO_COD_SUNAT")
            ...
            End Try
        End Sub
        Private Sub frmProvincia_Activated(ByVal sender As System.Object, ByVal e As System.EventArgs) _
            Handles MyBase.Activated
            If pComportamiento <> -1 Then
                Activado()
            End If
        End Sub
        Private Sub frmProvincia_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) _
            Handles MyBase.FormClosed
            If pComportamiento <> -1 Then
                Cerrado()
            End If
        End Sub
        Private Sub frmProvincia_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.MouseEnter
        ...
        Private Sub ConfigurarCheck()
            ...
            EchkPRO_ESTADO.pValorDefault = CheckState.Checked
        ...
        Private Sub ConfigurarText()
            EtxtDEP_ID.pTexto1 = ""
            EtxtDEP_ID.pTexto2 = ""
            EtxtDEP_ID.pSoloNumerosDecimales = False
            EtxtDEP_ID.pSoloNumeros = False
            EtxtDEP_ID.pParteEntera = 0
            EtxtDEP_ID.pParteDecimal = 0
            EtxtDEP_ID.pMinusculaMayuscula = True
            EtxtDEP_ID.pBusqueda = True
            EtxtDEP_ID.pCadenaFiltrado = ""

            EtxtDEP_ID.pOOrm = New Ladisac.BE.Departamento
            EtxtDEP_ID.pFormularioConsulta = True

            EtxtDEP_ID.pComportamiento = 1
            EtxtDEP_ID.pOrdenBusqueda = 0
        End Sub
        ...
        Private Sub txt_OnGotFocus(ByVal sender As Object, ByVal e As System.EventArgs) _
            Handles txtDEP_ID.GotFocus
            Select Case sender.name.ToString
                Case "txtDEP_ID"
                    EtxtDEP_ID.pTexto1 = sender.text
            End Select
        End Sub
        Private Sub txt_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) _
            Handles txtDEP_ID.LostFocus
            Select Case sender.name.ToString
                Case "txtDEP_ID"
                    EtxtDEP_ID.pTexto2 = sender.text
            End Select
        End Sub
        Private Sub txt_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs) _
            Handles txtDEP_ID.Validated
            Select Case sender.name.ToString
                Case "txtDEP_ID"
                    ValidarDatos(EtxtDEP_ID, txtDEP_ID)
            End Select
        End Sub
        Private Sub txt_OnKeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) _
            Handles txtDEP_ID.KeyDown
            Select Case sender.name.ToString
                Case "txtDEP_ID"
                    Select Case e.KeyCode
                        Case Keys.F1
                            If EtxtDEP_ID.pBusqueda Then
                                EtxtDEP_ID.pTexto2 = Me.Text
                                ValidarDatos(EtxtDEP_ID, txtDEP_ID)
                                MetodoBusquedaDato("", False, EtxtDEP_ID)
                                EtxtDEP_ID.pTexto1 = Me.Text
                                EtxtDEP_ID.pTexto2 = Me.Text
                            End If
                    End Select
            End Select
        ...
        Private Sub txt_OnKeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) _
            Handles txtDEP_ID.KeyPress
            Select Case sender.name.ToString
                Case "txtDEP_ID"
                    If EtxtDEP_ID.pMinusculaMayuscula Then
                        e.KeyChar = UCase(e.KeyChar)
                    End If
                    If EtxtDEP_ID.pSoloNumerosDecimales Then
                        If Not IsNumeric(e.KeyChar) Then
                            If Asc(e.KeyChar) <> 46 Then
                                ...
                                End If
                            Else
                                If EtxtDEP_ID.pParteDecimal = 0 Then
                                    e.KeyChar = ""
                                End If
                            End If
                        End If
                    End If
                    If EtxtDEP_ID.pSoloNumeros Then
                        If Not IsNumeric(e.KeyChar) Then
                            If Asc(e.KeyChar) <> 8 Then
                                e.KeyChar = ""
                            End If
        ...
        Private Sub txt_OnDoubleClick(ByVal sender As System.Object, ByVal e As System.EventArgs) _
            Handles txtDEP_ID.DoubleClick
            Select Case sender.name.ToString
                Case "txtDEP_ID"
                    EtxtDEP_ID.pTexto2 = txtDEP_ID.Text
                    ValidarDatos(EtxtDEP_ID, txtDEP_ID)
                    If Trim(txtDEP_ID.Text) = "" Then
                        Exit Sub
                    End If
                    If EtxtDEP_ID.pFormularioConsulta Then
                        Dim frmConsulta = Me.ContainerService.Resolve(Of Ladisac.Maestros.Views.frmDepartamento)()
                        frmConsulta.DatoBusquedaConsulta = txtDEP_ID.Text
        ...
        Private Sub ValidarDatos(ByRef otxt As txt, ByRef texto As TextBox)
            With otxt
                If .pTexto1 <> .pTexto2 Then
                    .pTexto2 = texto.Text
                    If .pBusqueda Then
                        MetodoBusquedaDato(texto.Text, True, EtxtDEP_ID)
                    End If
                End If
