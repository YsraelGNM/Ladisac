...
Namespace Ladisac.Maestros.Views
    Public Class frmBloqueoVendedor
#Region "Primaria 1"
        <Dependency()> _
...
#Region "Secundaria 1"
        ...
        <Dependency()> _
        Public Property IBC As Ladisac.BL.IBCBloqueoVendedor

        ' CheckBox
        Private EchkPER_ESTADO As New chk
        Private EchkBVE_ESTADO As New chk
        ...
        Private Simple As New Ladisac.BE.BloqueoVendedor
        Private Simple1 As New Ladisac.BE.Personas
        Private ErrorData As New Ladisac.BE.BloqueoVendedor.ErrorData
...
#Region "Secundaria 2"
        ...
        Private Sub LimpiarDatos()
            ...
            InicializarValores(chkBVE_ESTADO, ErrorProvider1, False, False, EchkBVE_ESTADO.pValorDefault)
            ColocarValoresDefault(chkBVE_ESTADO)
        End Sub
        ...
        Public Sub ColocarValoresDefault(ByRef vObjeto As CheckBox)
            ...
            Select Case vObjeto.Name
                ...
                Case "chkBVE_ESTADO"
                    vObjetoChk.pValorDefault = EchkBVE_ESTADO.pValorDefault
            End Select
        ...
        Private Function Ingresar() As Boolean
            ...
            End If
            Simple = Nothing
            Simple = New Ladisac.BE.BloqueoVendedor
            Return Ingresar
        End Function
        ...
        Private Sub DatosCabecera()
            ...
            Simple.BVE_FEC_GRAB = Now
            Simple.BVE_ESTADO = DevolverTiposCampos(chkBVE_ESTADO)
        End Sub
        ...
        Protected Function DevolverTiposCampos(ByRef oObjeto As CheckBox) As String
            Select Case oObjeto.Name.ToString
                ...
                Case "chkBVE_ESTADO"
                    Simple.CampoId = EchkBVE_ESTADO.pNombreCampo
                    Simple.Dato = oObjeto.Text
            End Select
        ...
        Private Function Validar(ByVal vModelos As String) As Boolean
            ...
            Select Case vModelos
                Case "Cabecera"
                    ...
                    resp.rM = Simple.ColocarErrores(btnImagen, Simple.VerificarDatos("BVE_FEC_GRAB"), ErrorProvider1)
                    resp.rM = Simple.ColocarErrores(chkBVE_ESTADO, Simple.VerificarDatos("BVE_ESTADO"), ErrorProvider1)
            End Select
            Return vrO
        End Function
        ...
        Private Sub ConfigurarCheck()
            ...
            EchkBVE_ESTADO = EchkTemporal
            EchkBVE_ESTADO.pNombreCampo = "BVE_ESTADO"
            EchkBVE_ESTADO.pValorDefault = CheckState.Checked
            ConfigurarCheck_Refrescar(EchkBVE_ESTADO)
        ...
        Public Sub Check_Refrescar()
            ...
            InicializarTexto(EchkBVE_ESTADO)
        End Sub
        ...
        Private Sub chk_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) _
            ...
            Select Case sender.name.ToString
                Case "chkPER_ESTADO"
                    ...
                    End If
                Case "chkBVE_ESTADO"
                    If EchkBVE_ESTADO.pFormatearTexto Then
                        InicializarTexto(EchkBVE_ESTADO)
                    End If
            End Select
        End Sub
