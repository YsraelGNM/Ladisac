...
Namespace Ladisac.Maestros.Views
    Public Class frmRolPuntoVentaAlmacen
#Region "Primaria"
        <Dependency()>
...
#Region "Secundaria"
        <Dependency()> _
        Public Property IBC As Ladisac.BL.IBCRolPuntoVentaAlmacen

        ' Controlar la clave de la tabla
        Public vCodigoALM_ID As String = ""

        ' CheckBox
        Private EchkPVE_ESTADO As New chk
        Private EchkALM_ESTADO As New chk
        Private EchkRPA_ESTADO As New chk
        ...
        Private Simple As New Ladisac.BE.RolPuntoVentaAlmacen
        Private Simple1 As New Ladisac.BE.PuntoVenta
        Private Simple2 As New Ladisac.BE.Almacen
        Private ErrorData As New Ladisac.BE.RolPuntoVentaAlmacen.ErrorData
        ...
        Private Sub LimpiarDatos()
            ...
            InicializarValores(chkRPA_ESTADO, ErrorProvider1, False, False, EchkRPA_ESTADO.pValorDefault)
            ColocarValoresDefault(chkRPA_ESTADO)
        End Sub
        ...
        Private Sub OrmBusquedaDatos(ByVal vProceso As String)
            Select Case vProceso
                ...
                Case "EliminarRegistro"
                    ...
                    Simple.ALM_ID = txtALM_ID.Text.Trim
                    vCodigoALM_ID = txtALM_ID.Text.Trim
        ...
        Private Sub DatosCabecera()
            ...
            Simple.RPA_FEC_GRAB = Now
            Simple.RPA_ESTADO = DevolverTiposCampos(chkRPA_ESTADO)
        End Sub
        Private Function Validar(ByVal vModelos As String) As Boolean
            ...
            Select Case vModelos
                Case "Cabecera"
                    ...
                    resp.rM = Simple.ColocarErrores(btnImagen, Simple.VerificarDatos("RPA_FEC_GRAB"), ErrorProvider1)
                    resp.rM = Simple.ColocarErrores(chkRPA_ESTADO, Simple.VerificarDatos("RPA_ESTADO"), ErrorProvider1)
            End Select
            Return vrO
        End Function
        Private Sub InicializarOrm()
            Simple = Nothing
            Simple = New Ladisac.BE.RolPuntoVentaAlmacen
        End Sub
        ...
        Private Sub NombresFormulariosControles()
            ...
            EtxtALM_ID.pOOrm = Simple2
            EtxtALM_ID.pComportamiento = 2
...
#Region "CheckBox"
        Private Sub ConfigurarCheck()
            ...
            EchkRPA_ESTADO = EchkTemporal
            EchkRPA_ESTADO.pNombreCampo = "RPA_ESTADO"

            ConfigurarCheck_Refrescar(EchkPVE_ESTADO)
            ConfigurarCheck_Refrescar(EchkALM_ESTADO)
            ConfigurarCheck_Refrescar(EchkRPA_ESTADO)
        End Sub
        Private Function DevolverTiposCampos(ByRef oObjeto As CheckBox) As String
            Select Case oObjeto.Name.ToString
                ...
                Case "chkALM_ESTADO"
                    ...
                    Simple.Dato = oObjeto.Text
                Case "chkRPA_ESTADO"
                    Simple.CampoId = EchkRPA_ESTADO.pNombreCampo
                    Simple.Dato = oObjeto.Text
            End Select
        ...
        Public Sub ColocarValoresDefault(ByRef vObjeto As CheckBox)
            ...
            Select Case vObjeto.Name
                ...
                Case "chkRPA_ESTADO"
                    vObjetoChk.pValorDefault = EchkRPA_ESTADO.pValorDefault
            End Select
        ...
        Handles chkPVE_ESTADO.CheckedChanged, chkALM_ESTADO.CheckedChanged, chkRPA_ESTADO.CheckedChanged
            Select Case sender.name.ToString
                ...
                Case "chkALM_ESTADO"
                    ...
                    End If
                Case "chkRPA_ESTADO"
                    If EchkRPA_ESTADO.pFormatearTexto Then
                        InicializarTextoCheck(EchkRPA_ESTADO)
                    End If
            End Select
        End Sub
...
#Region "TextBox"
        Private Sub ConfigurarText()
            ...
            EtxtALM_ID.pFormularioConsulta = False
