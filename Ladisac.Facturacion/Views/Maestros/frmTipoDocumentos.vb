...
#End Region
        ...
        Private Function Ingresar() As Boolean
            ...
            Ingresar = False
            DatosCabecera()
            ProcesoCrearCodigoIdDetalle("CrearCodigoSimple", vtxtDTD_ID, 3, "0")
        ...
        Private Function EliminarRegistroDetalle() As Int16
            ...
            Else
                ...
                For fila = 1 To eRegistrosEliminar.Count - 2
                    ...
                    EliminarRegistroDetalle = Me.IBCDetalle.DeleteRegistro(Compuesto1, eRegistrosEliminar(fila).cDTD_ID)
...
#Region "Secundaria"
        <Dependency()> _
        Public Property IBC As Ladisac.BL.IBCTipoDocumento

        <Dependency()> _
        Public Property IBCDetalle As Ladisac.BL.IBCDetalleTipoDocumento
        ...
        ' ComboBox
        Private EcboTDO_UBICACION As New cbo
        ...
        Private vtxtDTD_ID As New TextBox

        Private Compuesto As New Ladisac.BE.TipoDocumentos
        Private Compuesto1 As New Ladisac.BE.DetalleTipoDocumentos
        Private ErrorData As New Ladisac.BE.TipoDocumentos.ErrorData
        ...
        Private Sub LimpiarDatos()
            ...
            InicializarValores(cboTDO_UBICACION, ErrorProvider1)
        ...
        Private Sub CrearCodigoId()
            ProcesoCrearCodigoId("CrearCodigoSimple", txtTDO_ID)
        End Sub
        Private Sub HabilitarEscrituraNuevo()
            txtTDO_ID.ReadOnly = False
        End Sub
        Private Sub AdicionarFilasGrid()
            dgvDetalle.Rows.Add(txtTDO_ID.Text, "", "", _
                                "NINGUNO", "+", "+", "+", "NINGUNO", "NINGUNO", "ACTIVO", False)
        ...
        Private Function ProcesarDatosDetalle() As Int16
            ...
            While (dgvDetalle.Rows.Count() > vFilGrid)
                With dgvDetalle.Rows(vFilGrid)
                    ...
                    Else
                        Compuesto1.DTD_ID = vtxtDTD_ID.Text
                        vtxtDTD_ID.Text = Val(vtxtDTD_ID.Text) + 1
                        For a = 1 To (3 - Len(vtxtDTD_ID.Text.Trim()))
                            vtxtDTD_ID.Text = "0" & vtxtDTD_ID.Text
                        Next
                    End If

                    Compuesto1.TDO_ID = txtTDO_ID.Text
                    Compuesto1.DTD_DESCRIPCION = .Cells("cDTD_DESCRIPCION").Value
                    Compuesto1.DTD_CARGO_ABONO = DevolverTiposCampos("DTD_CARGO_ABONO", .Cells("cDTD_CARGO_ABONO").Value.ToString(), Compuesto1)
                    Compuesto1.DTD_SIGNO = DevolverTiposCampos("DTD_SIGNO", .Cells("cDTD_SIGNO").Value.ToString(), Compuesto1)
                    Compuesto1.DTD_SIGNO_D = DevolverTiposCampos("DTD_SIGNO_D", .Cells("cDTD_SIGNO_D").Value.ToString(), Compuesto1)
                    Compuesto1.DTD_SIGNO_D_1 = DevolverTiposCampos("DTD_SIGNO_D_1", .Cells("cDTD_SIGNO_D_1").Value.ToString(), Compuesto1)
                    DevolverTiposCampos("DTD_MOVIMIENTO", .Cells("cDTD_MOVIMIENTO").Value.ToString(), Compuesto1)
                    Compuesto1.DTD_MOVIMIENTO = DevolverTiposCampos("DTD_MOVIMIENTO", .Cells("cDTD_MOVIMIENTO").Value.ToString(), Compuesto1)
                    Compuesto1.DTD_PROCESO = DevolverTiposCampos("DTD_PROCESO", .Cells("cDTD_PROCESO").Value.ToString(), Compuesto1)
                    Compuesto1.USU_ID = SessionService.UserId
                    Compuesto1.DTD_FEC_GRAB = Now
                    Compuesto1.DTD_ESTADO = DevolverTiposCampos("DTD_ESTADO", .Cells("cDTD_ESTADO").Value.ToString(), Compuesto1)
                    Compuesto1.DTD_CONTROL = False
        ...
        Private Sub DatosCabecera()
            ...
            Compuesto.TDO_DESCRIPCION = Strings.Trim(txtTDO_DESCRIPCION.Text)
            Compuesto.TDO_UBICACION = DevolverTiposCampos("TDO_UBICACION", cboTDO_UBICACION.Text, Compuesto)
            Compuesto.USU_ID = SessionService.UserId
            Compuesto.TDO_FEC_GRAB = Now
            Compuesto.TDO_ESTADO = DevolverTiposCampos(chkTDO_ESTADO)
            Compuesto.TDO_CONTROL = True
            Compuesto.TDO_TABLA = ""
        End Sub
        Private Function Validar(ByVal vModelos As String) As Boolean
            ...
            Select Case vModelos
                Case "Cabecera"
                    ...
                    resp.rM = Compuesto.ColocarErrores(txtTDO_DESCRIPCION, Compuesto.VerificarDatos("TDO_DESCRIPCION"), ErrorProvider1)
                    resp.rM = Compuesto.ColocarErrores(cboTDO_UBICACION, Compuesto.VerificarDatos("TDO_UBICACION"), ErrorProvider1)
                    resp.rM = Compuesto.ColocarErrores(pnCuerpo, Compuesto.VerificarDatos("USU_ID"), ErrorProvider1)
                    resp.rM = Compuesto.ColocarErrores(btnImagen, Compuesto.VerificarDatos("TDO_FEC_GRAB"), ErrorProvider1)
                    resp.rM = Compuesto.ColocarErrores(chkTDO_ESTADO, Compuesto.VerificarDatos("TDO_ESTADO"), ErrorProvider1)
                Case "Detalle"
                    resp.rM = Compuesto1.ColocarErrores(dgvDetalle, _
                                                       Compuesto1.VerificarDatos("DTD_ID", _
                                                                                 "TDO_ID", _
                                                                                 "DTD_DESCRIPCION", _
                                                                                 "DTD_CARGO_ABONO", _
                                                                                 "DTD_SIGNO", _
        ...
        Private Sub InicializarOrm()
            InicializarOrmDetalle()
            Compuesto = Nothing
            Compuesto = New Ladisac.BE.TipoDocumentos
        End Sub
        Private Sub InicializarOrmDetalle()
            Compuesto1 = Nothing
            Compuesto1 = New Ladisac.BE.DetalleTipoDocumentos
        End Sub
        ...
        End Function
        Private Function EliminarDetalle(ByVal oOrm As DetalleTipoDocumentos) As Int16
            Return 1
        ...
        Private Sub AdicionarElementoCombosEdicion()
            BuscarFormatos(EcboTDO_UBICACION, Compuesto, cboTDO_UBICACION, 0)
        End Sub
...
#Region "CheckBox"
        Private Sub ConfigurarCheck()
            ...
            EchkTDO_ESTADO.pValorDefault = CheckState.Checked
        ...
        Private Function DevolverTiposCampos(ByRef oObjeto As CheckBox) As String
            Select Case oObjeto.Name.ToString
                Case "chkTDO_ESTADO"
                    Compuesto.CampoId = EchkTDO_ESTADO.pNombreCampo
        ...
        Private Sub chk_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) _
            Handles chkTDO_ESTADO.CheckedChanged
...
#Region "DataGridView"
        ...
        Private Sub dgvDetalle_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) _
          Handles dgvDetalle.KeyDown
            ...
            Select Case sender.Columns(dgvDetalle.CurrentCell.ColumnIndex).Name.ToString
                ' Configurar ' si se desea utilizar búsqueda de campo
                'Case "cTDO_ID"
                '    Select Case e.KeyCode
                '        Case Keys.F1
                '            If EtxtTDO_ID.pBusqueda Then
                '                EtxtTDO_ID.pTexto2 = Me.Text
                '                ' ValidarDatos(EtxtTDO_ID, txtTDO_ID)
                '                MetodoBusquedaDato("", False, EtxtTDO_ID)
                '                EtxtTDO_ID.pTexto1 = Me.Text
                '                EtxtTDO_ID.pTexto2 = Me.Text
                '            End If
                '    End Select
            End Select
        ...
        Private Sub dgvDetalle_CellLeave(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) _
           Handles dgvDetalle.CellLeave
            ...
            '    Select Case sender.Columns(dgvDetalle.CurrentCell.ColumnIndex).Name.ToString
            '        Case "cTDO_ID"
            '            EtxtTDO_ID.pTexto2 = dgvDetalle.Item(dgvDetalle.CurrentCell.ColumnIndex, dgvDetalle.CurrentRow.Index).Value.ToString
            '    End Select
        End Sub
        Private Sub dgvDetalle_CellEnter(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) _
            ...
            'Select Case sender.Columns(dgvDetalle.CurrentCell.ColumnIndex).Name.ToString
            'Case "cTDO_ID"
            'EtxtTDO_ID.pTexto1 = dgvDetalle.Item(dgvDetalle.CurrentCell.ColumnIndex, dgvDetalle.CurrentRow.Index).Value.ToString
            'End Select
        End Sub
#End Region
#Region "TextBox"
...
#Region "Secundaria 2"
        Private Sub FormatearCampos()
            ...
            FormatearCampos(txtTDO_DESCRIPCION, "TDO_DESCRIPCION", EtxtTDO_DESCRIPCION)
            FormatearCampos(cboTDO_UBICACION, "TDO_UBICACION", Nothing)

            FormatearCamposD(cDTD_DESCRIPCION, "DTD_DESCRIPCION", EtxtDTD_DESCRIPCION)
        End Sub
        ...
        End Sub
        Public Sub FormatearCamposD(ByRef oObjeto As Object, ByVal NombreCampo As String, ByRef sender As txt, Optional ByVal e As System.Boolean = True)
...
#Region "ComboBox"
        Private Sub ConfigurarComboBox()
            EcboTDO_UBICACION.pNombreCampo = "TDO_UBICACION"
            cboTDO_UBICACION.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList
        End Sub
#End Region

#Region "TextBox"
        Private Sub txt_OnGotFocus(ByVal sender As Object, ByVal e As System.EventArgs) _
        Handles btnImagen.GotFocus

        End Sub
        Private Sub txt_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) _
        Handles btnImagen.LostFocus

        End Sub
        Private Sub txt_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs) _
            Handles txtTDO_ID.Validated, _
                    txtTDO_DESCRIPCION.Validated
            Select Case sender.name.ToString
                Case "txtTDO_ID"
                    ValidarDatos(EtxtTDO_ID, txtTDO_ID)
                Case "txtTDO_DESCRIPCION"
                    ValidarDatos(EtxtTDO_DESCRIPCION, txtTDO_DESCRIPCION)
            End Select
        End Sub
...
#End Region
        ...
        'Private Sub dgvDetalle_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) _
        '    Handles dgvDetalle.KeyPress
        '    MsgBox(EtxtDTD_DESCRIPCION.pMinusculaMayuscula & " - " & sender.Columns(dgvDetalle.CurrentCell.ColumnIndex).Name.ToString)
        '    Select Case sender.Columns(dgvDetalle.CurrentCell.ColumnIndex).Name.ToString
        '        Case "cDTD_DESCRIPCION"
        '            If EtxtDTD_DESCRIPCION.pMinusculaMayuscula Then
        '                e.KeyChar = UCase(e.KeyChar)
        '            End If
        '            If EtxtDTD_DESCRIPCION.pSoloNumerosDecimales Then
        '                If Not IsNumeric(e.KeyChar) Then
        '                    If Asc(e.KeyChar) <> 46 Then
        '                        If Asc(e.KeyChar) <> 8 Then
        '                            e.KeyChar = ""
        '                        End If
        '                    Else
        '                        If EtxtDTD_DESCRIPCION.pParteDecimal = 0 Then
        '                            e.KeyChar = ""
        '                        End If
        '                    End If
        '                End If
        '            End If
        '            If EtxtDTD_DESCRIPCION.pSoloNumeros Then
        '                If Not IsNumeric(e.KeyChar) Then
        '                    If Asc(e.KeyChar) <> 8 Then
        '                        e.KeyChar = ""
        '                    End If
