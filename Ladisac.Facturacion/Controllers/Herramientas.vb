...
Public Class Herramientas
    ...
    Public Sub excelExportar(ByVal oDAta As System.Data.DataTable, Optional ByVal Titulo As String = "Exportado")
        ...
        Try
            ...
            'para el Titulo
            exHoja.Cells.Item(1, 1) = Titulo
            '''''
            For i As Integer = 1 To NCol
                exHoja.Cells.Item(2, i) = oDAta.Columns(i - 1).ColumnName.ToString
            Next
            For Fila As Integer = 0 To NRow - 1
                For Col As Integer = 0 To NCol - 1
                    exHoja.Cells.Item(Fila + 3, Col + 1) = oDAta.Rows(Fila).Item(Col)
                Next
            Next
    ...
    Public Shared Function ToTable(ByVal DataGridView As DataGridView, ByVal tableName As String, Optional ByVal SoloVisible As Boolean = True) As DataTable
        ...
        If SoloVisible Then
            For iCol = 0 To dgv.Columns.Count - 1
                For mCol = table.Columns.Count - 1 To 0 Step -1
                    If dgv.Columns(iCol).Name = table.Columns(mCol).ColumnName Then
                        If dgv.Columns(iCol).Visible = False Then
                            table.Columns.Remove(table.Columns(mCol))
                        End If
                    End If
                Next
            Next
