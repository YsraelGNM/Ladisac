...
Public Class frmUbicacionAlmacen
    <Dependency()> _
    ...
    Protected mUbicacionAlmacen As UbicacionAlmacen


    Private Sub frmUbicacionAlmacen_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LimpiarControles()
    ...
    Sub LlenarControles()
        txtCodigo.Text = mUbicacionAlmacen.UBI_ID
        txtDescripcion.Text = mUbicacionAlmacen.UBI_DESCRIPCION
    End Sub
    ...
    Sub CargarUbicacionAlmacen(ByVal UBI_Id As Integer)
        mUbicacionAlmacen = BCUbicacionAlmacen.UbicacionAlmacenGetById(UBI_Id)
        mUbicacionAlmacen.MarkAsModified()
    End Sub
    ...
    Public Overrides Sub OnManGuardar()
        ...
        If mUbicacionAlmacen IsNot Nothing Then
            mUbicacionAlmacen.UBI_DESCRIPCION = txtDescripcion.Text
            mUbicacionAlmacen.UBI_ESTADO = True
            mUbicacionAlmacen.UBI_FEC_GRAB = Now
            mUbicacionAlmacen.USU_ID = SessionServer.UserId
            BCUbicacionAlmacen.MantenimientoUbicacionAlmacen(mUbicacionAlmacen)
            MessageBox.Show(mUbicacionAlmacen.UBI_ID)
            LimpiarControles()
    ...
    Public Overrides Sub OnManNuevo()
        LimpiarControles()
        mUbicacionAlmacen = New UbicacionAlmacen
        mUbicacionAlmacen.MarkAsAdded()
