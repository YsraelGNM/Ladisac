...
Public Class frmMarcaArticulo
    ...
    Protected mMarcaArticulo As MarcaArticulos
    'ingreso de codigo
    Private Sub frmMarcaArticulo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LimpiarControles()
    ...
    Sub LlenarControles()
        txtCodigo.Text = mMarcaArticulo.MAR_ID
        txtDescripcion.Text = mMarcaArticulo.MAR_DESCRIPCION
    End Sub
    ...
    Sub CargarMarcaArticulo(ByVal MAR_Id As String)
        mMarcaArticulo = BCMarcaArticulo.MarcaArticuloGetById(MAR_Id)
        mMarcaArticulo.MarkAsModified()
    End Sub
    ...
    Public Overrides Sub OnManGuardar()
        ...
        If mMarcaArticulo IsNot Nothing Then
            mMarcaArticulo.MAR_DESCRIPCION = txtDescripcion.Text
            mMarcaArticulo.MAR_ESTADO = True
            mMarcaArticulo.MAR_FEC_GRAB = Now
            mMarcaArticulo.USU_ID = SessionServer.UserId
            BCMarcaArticulo.MantenimientoMarcaArticulo(mMarcaArticulo)
            MessageBox.Show(mMarcaArticulo.MAR_ID)
            LimpiarControles()
        End If
    ...
    Public Overrides Sub OnManNuevo()
        LimpiarControles()
        mMarcaArticulo = New MarcaArticulos
        mMarcaArticulo.MarkAsAdded()
