...
Imports System.IO
Public Class frmRptKardexConsolidado
    <Dependency()> _
    Public Property BCKardex As Ladisac.BL.IBCKardex
    Private Sub frmRptKardexConsolidado_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnVisualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVisualizar.Click
        ...
        Dim query = BCKardex.ListaKardexConsolidado(dtpFecIni.Value, dtpFecFin.Value, txtAlmacen.Tag, txtArticulo.Tag)
        ...
        Try
            ...
            ReportViewer1.LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("dsListaKardexConsolidado", ds.Tables(0)))
