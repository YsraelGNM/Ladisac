...
Namespace Ladisac.Logistica.Views
    ...
    Public Class frmRptKardex
        ...
        Private Sub btnVisualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVisualizar.Click
            ...
            Dim query = BCKardex.ListaKardex(dtpFecIni.Value, dtpFecFin.Value, txtAlmacen.Tag, txtArticulo.Tag)
            ...
            Try
                ...
                ReportViewer1.LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("dsListaKardex", ds.Tables(0)))
            ...
            Catch ex As Exception
                ReportViewer1.LocalReport.DataSources.Clear()
                ReportViewer1.LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("dsListaKardex", New DataTable()))
                ReportViewer1.RefreshReport()
            End Try
        End Sub
