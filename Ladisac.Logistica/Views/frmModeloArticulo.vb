...
Public Class frmModeloArticulo
    <Dependency()> _
    ...
    Protected mModeloArticulo As ModeloArticulos

    'ingreso de codigo
    Private Sub frmModeloArticulo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LimpiarControles()
    ...
    Sub LlenarControles()
        txtCodigo.Text = mModeloArticulo.MOD_ID
        txtDescripcion.Text = mModeloArticulo.MOD_DESCRIPCION
    End Sub
    ...
    Sub CargarModeloArticulo(ByVal MOD_Id As String)
        mModeloArticulo = BCModeloArticulo.ModeloArticuloGetById(MOD_Id)
        mModeloArticulo.MarkAsModified()
    End Sub
    ...
    Public Overrides Sub OnManGuardar()
        ...
        If mModeloArticulo IsNot Nothing Then
            mModeloArticulo.MOD_DESCRIPCION = txtDescripcion.Text
            mModeloArticulo.MOD_ESTADO = True
            mModeloArticulo.MOD_FEC_GRAB = Now
            mModeloArticulo.USU_ID = SessionServer.UserId
            BCModeloArticulo.MantenimientoModeloArticulo(mModeloArticulo)
            MessageBox.Show(mModeloArticulo.MOD_ID)
            LimpiarControles()
        End If
    ...
    Public Overrides Sub OnManNuevo()
        LimpiarControles()
        mModeloArticulo = New ModeloArticulos
        mModeloArticulo.MarkAsAdded()
