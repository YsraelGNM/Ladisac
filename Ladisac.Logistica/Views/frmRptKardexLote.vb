...
Public Class frmRptKardexLote
    <Dependency()> _
    Public Property BCKardex As Ladisac.BL.IBCKardex


    Private Sub frmRptKardexLote_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub btnVisualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVisualizar.Click
        ...
        Try
            Dim query = BCKardex.ListaKardexLote(dtpFecIni.Value, dtpFecFin.Value, txtAlmacen.Tag, txtArticulo.Tag, txtSerie.Text, txtNumero.Text)
            Dim rea As New StringReader(query)
            ds.ReadXml(rea)
            ReportViewer1.LocalReport.DataSources.Clear()
            ReportViewer1.LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("dsListaKardexLote", ds.Tables(0)))
        ...
        Catch ex As Exception
            ReportViewer1.LocalReport.DataSources.Clear()
            ReportViewer1.LocalReport.DataSources.Add(New Microsoft.Reporting.WinForms.ReportDataSource("dsListaKardexLote", New DataTable()))
            ReportViewer1.RefreshReport()
        End Try
    End Sub
